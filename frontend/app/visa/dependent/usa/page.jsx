...
function USFlag({ className }) {
  return (
    <svg className={className} viewBox="0 0 100 100">
      ...
      <rect x="10" y="10" width="80" height="6" fill="#B22234"/>
      <rect x="10" y="16" width="80" height="6" fill="white"/>
      <rect x="10" y="22" width="80" height="6" fill="#B22234"/>
      <rect x="10" y="28" width="80" height="6" fill="white"/>
      <rect x="10" y="34" width="80" height="6" fill="#B22234"/>
      <rect x="10" y="40" width="80" height="6" fill="white"/>
      <rect x="10" y="46" width="80" height="6" fill="#B22234"/>
      <rect x="10" y="52" width="80" height="6" fill="white"/>
      <rect x="10" y="58" width="80" height="6" fill="#B22234"/>
      <rect x="10" y="64" width="80" height="6" fill="white"/>
      <rect x="10" y="70" width="80" height="6" fill="#B22234"/>
      <rect x="10" y="76" width="80" height="6" fill="white"/>
      <rect x="10" y="82" width="80" height="6" fill="#B22234"/>
      <rect x="10" y="10" width="32" height="42" fill="#3C3B6E"/>
      <circle cx="26" cy="31" r="8" fill="white" opacity="0.3"/>
    </svg>
  );
}

const USDependentPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* ═══════════════════════════════════════
          ...
          ═══════════════════════════════════════ */}
      <a
        href={whatsappLink("Hi, I'm interested in US Dependent Visa. Please share more information.")}
        target="_blank"
        ...
        >
          ...
          >
            ...
            <div className="flex gap-3">
              <a
                href={whatsappLink("Hi, I just submitted an enquiry for US Dependent Visa. Please assist me further.")}
                target="_blank"
                rel="noopener noreferrer"
      ...
      {/* ═══════════════════════════════════════
          HERO SECTION — RED, WHITE & BLUE THEME (USA)
          ═══════════════════════════════════════ */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
                Dependent Visa<br /><span className="text-blue-200">United States</span>
              </h1>
              <p className="text-lg text-blue-100 leading-relaxed max-w-xl">
                Bring your spouse, children, and parents to the United States. 
                H-4 visa for spouses, F-2 for student dependents, and visitor visas for parents. 
                Build your American dream together with your loved ones.
              </p>
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl bg-blue-900">
                {!imgError.hero ? (
                  <Image
                    src="/USA-image.png"
                    alt="United States Dependent Visa"
                    width={600}
                    height={400}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-600 leading-relaxed">
                The United States offers several pathways for families to reunite. If you are a 
                student, worker, or permanent resident in the US, you can bring your spouse, 
                children, and parents to live with you and share the American experience.
              </p>
              <p className="text-gray-600 leading-relaxed">
                The dependent visa program includes H-4 for H-1B worker spouses, F-2 for student 
                dependents, J-2 for exchange visitor dependents, and visitor visas for parents. 
                Each category is designed to keep families together during your stay in the US.
              </p>
              <p className="text-gray-600 leading-relaxed">
      ...
      {/* ═══════════════════════════════════════
          WHY US DEPENDENT VISA SECTION
          ═══════════════════════════════════════ */}
      <section className="py-16 lg:py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              Why Choose US Dependent Visa?
            </h2>
            <p className="text-gray-500 max-w-xl mx-auto">
              Key reasons families choose the United States for reunification
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "H-4 EAD allows certain spouses to work legally in the US. Build your career while supporting your family.",
              },
              {
                icon: BookOpen,
                title: "Education for Kids",
                desc: "Children can attend US schools and universities. Access to world-class education from kindergarten to college.",
              },
              {
                icon: Heart,
              ...
              },
              {
                ...
                desc: "Dependents can access quality healthcare through employer plans or private insurance in the US.",
              },
              {
                icon: Award,
                title: "Green Card Pathway",
                desc: "Dependent status can lead to permanent residency. Family-based immigration is a key pathway to a Green Card.",
              },
              {
                icon: Globe,
                title: "Quality of Life",
                desc: "Safe neighborhoods, modern infrastructure, diverse culture, and excellent amenities for your family.",
              },
              {
                icon: Wallet,
                title: "Strong Economy",
                desc: "The US offers a robust economy with excellent earning potential for skilled professionals and their families.",
              },
              {
                icon: GraduationCap,
                title: "World-Class Education",
                desc: "Access to top-ranked universities and research institutions. Children benefit from America's excellent education system.",
              },
              {
                icon: Star,
                title: "Diverse Society",
                desc: "The US is a melting pot of cultures. Your family will feel welcome in this inclusive and vibrant society.",
              },
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {[
              ...
              },
              {
                ...
                desc: "Practical guidance on relocating to the US, including housing, banking, and local services.",
              },
            ].map(({ icon: Icon, title, desc }, i) => (
              <div
                key={i}
          ...
          <div className="mt-12 bg-blue-50 border border-blue-100 rounded-2xl p-8 max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a
                href={whatsappLink("Hi, I want to know more about US Dependent Visa.")}
                target="_blank"
                rel="noopener noreferrer"
            ...
            <div className="grid lg:grid-cols-2">
              <div className="bg-blue-900 p-8 lg:p-12 text-white">
                ...
                <p className="text-blue-100 mb-8 text-sm leading-relaxed">
                  Fill out the form and our experts will guide you through the entire US dependent visa process.
                </p>
                <div className="space-y-5">
                  ...
                  <a href={whatsappLink("Hi, I'm interested in US Dependent Visa. Please share more information.")} target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 hover:translate-x-1 transition-transform">
                    <div className="w-11 h-11 bg-white/10 rounded-lg flex items-center justify-center shrink-0">
                ...
                <form onSubmit={handleSubmit} noValidate className="space-y-5">
                  ...
                  <div>
                    ...
                    <select id="purpose" name="purpose" required value={formData.purpose} onChange={handleInputChange} className={`w-full px-4 py-3 border-2 ${formErrors.purpose ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : 'border-gray-200 focus:ring-blue-500 focus:border-blue-500'} rounded-lg outline-none transition-all text-gray-900`}>
                      ...
                      <option value="h4-visa">H-4 Visa (Spouse of H-1B)</option>
                      <option value="f2-visa">F-2 Visa (Student Dependent)</option>
                      <option value="j2-visa">J-2 Visa (Exchange Visitor Dependent)</option>
                      <option value="l2-visa">L-2 Visa (Intra-Company Transfer Dependent)</option>
                      <option value="visitor-parents">Visitor Visa for Parents</option>
                  ...
                  <a href={whatsappLink("Hi, I'm interested in US Dependent Visa. Please share more information.")} target="_blank" rel="noopener noreferrer" className="w-full bg-[#25D366] text-white py-4 rounded-lg font-semibold hover:bg-[#1ebe57] transition-colors flex items-center justify-center gap-2">
      ...
      {/* ═══════════════════════════════════════
          ...
          ═══════════════════════════════════════ */}
      <section className="relative bg-gradient-to-r from-blue-900 via-blue-800 to-red-700 text-white py-16 overflow-hidden">
        <div className="container mx-auto px-4 relative z-10 text-center max-w-3xl mx-auto">
          <h2 className="text-3xl lg:text-4xl font-bold mb-4">
            Reunite with Your Family in the <span className="text-blue-200">United States</span>
          </h2>
          <p className="text-lg text-blue-100 mb-8">
            Let IIL guide you toward bringing your loved ones to the US. Contact us today!
          </p>
          <div className="flex flex-wrap justify-center gap-4">
...
export default USDependentPage;