  ...
  return (
    <svg className={className} viewBox="0 0 100 100">
      ...
      <g clipPath="url(#ukClip)">
        ...
        <path d="M50 10 L50 90 M10 50 L90 50" stroke="white" strokeWidth="16"/>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* ═══════════════════════════════════════
          ...
          ═══════════════════════════════════════ */}
      <a
        href={whatsappLink("Hi, I'm interested in UK Dependent Visa. Please share more information.")}
        target="_blank"
        ...
        >
          ...
          >
            ...
            <div className="flex gap-3">
              <a
                href={whatsappLink("Hi, I just submitted an enquiry for UK Dependent Visa. Please assist me further.")}
                target="_blank"
                rel="noopener noreferrer"
      ...
      {/* ═══════════════════════════════════════
          HERO SECTION — INDIGO/BLUE THEME (UK)
          ═══════════════════════════════════════ */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
                Dependent Visa<br /><span className="text-blue-200">United Kingdom</span>
              </h1>
              <p className="text-lg text-indigo-100 leading-relaxed max-w-xl">
                Bring your spouse, children, and parents to the UK. Full work rights for dependents,
                world-class education for kids, and family-friendly visa pathways.
              </p>
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl bg-indigo-900">
                ...
                <div className="absolute top-4 right-4 bg-white/95 backdrop-blur-sm rounded-xl px-4 py-3 shadow-lg">
                  ...
                  <div className="text-lg font-bold text-indigo-700">DEPENDENT VISA</div>
                </div>
              </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-600 leading-relaxed">
                The United Kingdom values family unity and offers several pathways for dependents
                to join their loved ones. Whether you are a student, skilled worker, or settled resident,
                you can bring your spouse, children, and parents to live with you in the UK.
              </p>
              <p className="text-gray-600 leading-relaxed">
                UK dependent visas allow your family members to work, study, and access healthcare
                through the National Health Service (NHS). Children can attend world-renowned schools
                and universities.
              </p>
              <p className="text-gray-600 leading-relaxed">
      ...
      {/* ═══════════════════════════════════════
          WHY UK DEPENDENT VISA SECTION
          ═══════════════════════════════════════ */}
      <section className="py-16 lg:py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              Why Choose UK Dependent Visa?
            </h2>
            <p className="text-gray-500 max-w-xl mx-auto">
              Key reasons families choose the United Kingdom for reunification
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Dependent visa holders can work full-time for any employer in the UK without restrictions.",
              },
              {
                icon: BookOpen,
                title: "World-Class Education",
                desc: "Children can attend top UK schools and universities. Access to globally recognised education system.",
              },
              {
                icon: Heart,
              ...
              },
              {
                ...
                desc: "Dependents get access to the National Health Service, one of the world's finest public healthcare systems.",
              },
              {
                icon: Award,
                title: "Settlement Pathway",
                desc: "Time spent on dependent visa counts toward settlement. Family route leads to Indefinite Leave to Remain.",
              },
              {
                icon: Globe,
                title: "Quality of Life",
                desc: "Safe cities, rich cultural heritage, excellent transport, and vibrant multicultural communities.",
              },
              {
                icon: Wallet,
                title: "Strong Economy",
                desc: "The UK offers a robust economy with excellent career opportunities across diverse industries.",
              },
              {
                icon: GraduationCap,
                title: "Top Universities",
                desc: "Home to Oxford, Cambridge, and many world-leading institutions. Children benefit from exceptional academics.",
              },
              {
                icon: Star,
                title: "Welcoming Society",
                desc: "The UK is known for its diversity and inclusion, warmly welcoming families from all corners of the world.",
              },
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {[
              ...
              },
              {
                ...
                desc: "Practical guidance on relocating to the UK, including housing, banking, and local services.",
              },
            ].map(({ icon: Icon, title, desc }, i) => (
              <div
                key={i}
          ...
          <div className="mt-12 bg-indigo-50 border border-indigo-100 rounded-2xl p-8 max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a
                href={whatsappLink("Hi, I want to know more about UK Dependent Visa.")}
                target="_blank"
                rel="noopener noreferrer"
              ...
              <div className="bg-indigo-900 p-8 lg:p-12 text-white">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-indigo-100">Dependent Visa</p>
                  </div>
                </div>
                <p className="text-indigo-100 mb-8 text-sm leading-relaxed">
                  Fill out the form and our experts will guide you through the entire UK dependent visa process.
                </p>
                <div className="space-y-5">
                  ...
                  <a href={whatsappLink("Hi, I'm interested in UK Dependent Visa. Please share more information.")} target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 hover:translate-x-1 transition-transform">
                    <div className="w-11 h-11 bg-white/10 rounded-lg flex items-center justify-center shrink-0">
                ...
                <div className="mt-8 pt-6 border-t border-white/20">
                  <div className="flex items-center gap-3 mb-5">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-indigo-200">Guiding families on their visa journey</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                ...
                <form onSubmit={handleSubmit} noValidate className="space-y-5">
                  ...
                  <div>
                    ...
                    <select id="purpose" name="purpose" required value={formData.purpose} onChange={handleInputChange} className={`w-full px-4 py-3 border-2 ${formErrors.purpose ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : 'border-gray-200 focus:ring-indigo-500 focus:border-indigo-500'} rounded-lg outline-none transition-all text-gray-900`}>
                      ...
                      <option value="work-dependent">Skilled Worker Dependent</option>
                      <option value="ancestry-dependent">Ancestry Dependent</option>
                  ...
                  <div>
                    ...
                    <textarea id="message" name="message" rows={3} autoComplete="off" placeholder="Tell us about your dependent visa requirements..." value={formData.message} onChange={handleInputChange} className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all resize-none text-gray-900 placeholder-gray-400" />
                  </div>
                  ...
                  <a href={whatsappLink("Hi, I'm interested in UK Dependent Visa. Please share more information.")} target="_blank" rel="noopener noreferrer" className="w-full bg-[#25D366] text-white py-4 rounded-lg font-semibold hover:bg-[#1ebe57] transition-colors flex items-center justify-center gap-2">
      ...
      <section className="relative bg-gradient-to-r from-indigo-900 via-indigo-800 to-blue-700 text-white py-16 overflow-hidden">
        <div className="container mx-auto px-4 relative z-10 text-center max-w-3xl mx-auto">
          <h2 className="text-3xl lg:text-4xl font-bold mb-4">
            Reunite with Your Family in the <span className="text-indigo-200">United Kingdom</span>
          </h2>
          <p className="text-lg text-indigo-100 mb-8">
            Let IIL guide you toward bringing your loved ones to the UK. Contact us today!
          </p>
          <div className="flex flex-wrap justify-center gap-4">
...
export default UKDependentPage;