...
function CanadaFlag({ className }) {
  return (
    <svg className={className} viewBox="0 0 100 100">
      ...
      <rect x="10" y="10" width="26" height="80" fill="#D52B1E"/>
      <rect x="64" y="10" width="26" height="80" fill="#D52B1E"/>
      <rect x="36" y="10" width="28" height="80" fill="white"/>
      <path fill="#D52B1E" d="M50 25 L45 35 L50 35 L47 45 L52 45 L50 55 L55 50 L52 50 L55 40 L50 40 L53 30 L50 30 Z"/>
    </svg>
  );
}

const CanadaDependentPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* ═══════════════════════════════════════
          ...
          ═══════════════════════════════════════ */}
      <a
        href={whatsappLink("Hi, I'm interested in Canada Dependent Visa. Please share more information.")}
        target="_blank"
        ...
        >
          ...
          >
            ...
            <div className="flex gap-3">
              <a
                href={whatsappLink("Hi, I just submitted an enquiry for Canada Dependent Visa. Please assist me further.")}
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
                Dependent Visa<br /><span className="text-red-200">Canada</span>
              </h1>
              <p className="text-lg text-red-100 leading-relaxed max-w-xl">
                Bring your spouse, children, and parents to Canada. Open work permit for spouse,
                free education for kids, and Super Visa for parents.
              </p>
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl bg-red-900">
                ...
                <div className="absolute top-4 right-4 bg-white/95 backdrop-blur-sm rounded-xl px-4 py-3 shadow-lg">
                  ...
                  <div className="text-lg font-bold text-red-700">DEPENDENT VISA</div>
                </div>
              </div>
      ...
      {/* ═══════════════════════════════════════
          ABOUT CANADA DEPENDENT SECTION
          ═══════════════════════════════════════ */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-600 leading-relaxed">
                Canada believes in keeping families together. If you are a student or worker in Canada,
                you can bring your spouse, children, and even parents to live with you.
              </p>
              <p className="text-gray-600 leading-relaxed">
                The dependent visa allows your family members to join you in Canada, work, study,
                and enjoy the same benefits as Canadian residents.
              </p>
              <p className="text-gray-600 leading-relaxed">
      ...
      {/* ═══════════════════════════════════════
          WHY CANADA DEPENDENT VISA SECTION
          ═══════════════════════════════════════ */}
      <section className="py-16 lg:py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              Why Choose Canada Dependent Visa?
            </h2>
            <p className="text-gray-500 max-w-xl mx-auto">
              Key reasons families choose Canada for reunification
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Open work permit allows spouse to work full-time for any employer in Canada without restrictions.",
              },
              {
                icon: BookOpen,
                title: "Free Education for Kids",
                desc: "Children can attend Canadian public schools for free. World-class education without tuition fees.",
              },
              {
                icon: Heart,
              ...
              },
              {
                ...
                desc: "Dependents get access to Canada's world-class public healthcare system in most provinces.",
              },
              {
                icon: Award,
                title: "PR Pathway",
                desc: "Canadian work experience from spouse adds CRS points. Family sponsorship leads to permanent residency.",
              },
              {
                icon: Globe,
                title: "Quality of Life",
                desc: "Safe environment, multicultural society, clean air, and excellent infrastructure for your family.",
              },
              {
                icon: Wallet,
                title: "Strong Economy",
                desc: "Canada offers a stable economy with excellent earning potential for skilled professionals and their families.",
              },
              {
                icon: GraduationCap,
                title: "World-Class Education",
                desc: "Access to top-ranked universities and schools. Children benefit from Canada's excellent education system.",
              },
              {
                icon: Star,
                title: "Welcoming Society",
                desc: "Canada is known for its multicultural and inclusive society that warmly welcomes families from around the world.",
              },
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-12 bg-red-50 border border-red-100 rounded-2xl p-8 max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a
                href={whatsappLink("Hi, I want to know more about Canada Dependent Visa.")}
                target="_blank"
                rel="noopener noreferrer"
              ...
              <div className="bg-red-900 p-8 lg:p-12 text-white">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-red-100">Dependent Visa</p>
                  </div>
                </div>
                <p className="text-red-100 mb-8 text-sm leading-relaxed">
                  Fill out the form and our experts will guide you through the entire Canada dependent visa process.
                </p>
                <div className="space-y-5">
                  ...
                  <a href={whatsappLink("Hi, I'm interested in Canada Dependent Visa. Please share more information.")} target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 hover:translate-x-1 transition-transform">
                    <div className="w-11 h-11 bg-white/10 rounded-lg flex items-center justify-center shrink-0">
                ...
                <div className="mt-8 pt-6 border-t border-white/20">
                  <div className="flex items-center gap-3 mb-5">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-red-200">Guiding families on their visa journey</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                ...
                <form onSubmit={handleSubmit} noValidate className="space-y-5">
                  ...
                  <div>
                    ...
                    <select id="purpose" name="purpose" required value={formData.purpose} onChange={handleInputChange} className={`w-full px-4 py-3 border-2 ${formErrors.purpose ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : 'border-gray-200 focus:ring-red-500 focus:border-red-500'} rounded-lg outline-none transition-all text-gray-900`}>
                      ...
                      <option value="spouse-work-permit">Spouse Open Work Permit</option>
                      <option value="children-study">Children Study Permit</option>
                      <option value="super-visa">Super Visa (Parents)</option>
                      <option value="visitor-visa">Visitor Visa (TRV)</option>
                      <option value="inland-sponsorship">Inland Sponsorship</option>
                  ...
                  <div>
                    ...
                    <textarea id="message" name="message" rows={3} autoComplete="off" placeholder="Tell us about your dependent visa requirements..." value={formData.message} onChange={handleInputChange} className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none transition-all resize-none text-gray-900 placeholder-gray-400" />
                  </div>
                  ...
                  <a href={whatsappLink("Hi, I'm interested in Canada Dependent Visa. Please share more information.")} target="_blank" rel="noopener noreferrer" className="w-full bg-[#25D366] text-white py-4 rounded-lg font-semibold hover:bg-[#1ebe57] transition-colors flex items-center justify-center gap-2">
      ...
      <section className="relative bg-gradient-to-r from-red-900 via-red-800 to-rose-700 text-white py-16 overflow-hidden">
        <div className="container mx-auto px-4 relative z-10 text-center max-w-3xl mx-auto">
          <h2 className="text-3xl lg:text-4xl font-bold mb-4">
            Reunite with Your Family in <span className="text-red-200">Canada</span>
          </h2>
          <p className="text-lg text-red-100 mb-8">
            Let IIL guide you toward bringing your loved ones to Canada. Contact us today!
          </p>
          <div className="flex flex-wrap justify-center gap-4">
...
export default CanadaDependentPage;