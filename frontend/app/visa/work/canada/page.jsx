...
import {
  ...
  Camera, Sun, Star, MapPinned, BriefcaseBusiness,
  TrendingUp, Wallet, UserCheck, FileCheck,
  GraduationCap
} from "lucide-react";
...
const CanadaWorkPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Floating WhatsApp */}
      <a
        href={whatsappLink("Hi, I\'m interested in Canada Work Visa. Please share more information.")}
        target="_blank"
        ...
        >
          ...
          >
            ...
            <div className="flex gap-3">
              <a
                href={whatsappLink("Hi, I just submitted an enquiry for Canada Work Visa. Please assist me further.")}
                target="_blank"
                rel="noopener noreferrer"
      ...
      <section className="relative bg-gradient-to-br from-red-900 via-red-800 to-rose-700 text-white overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
                Work in <span className="block text-rose-200">Canada</span>
              </h1>
              <p className="text-lg text-red-100 leading-relaxed max-w-xl">
                Build your career in one of the world&apos;s most welcoming countries. 
                Canada offers excellent work-life balance, competitive salaries, 
                and a clear pathway to permanent residency. Let IIL guide you through the process.
              </p>
              <div className="flex flex-wrap gap-4">
                <button
                  onClick={() => scrollToSection("enquiry")}
                  className="bg-white text-red-900 px-8 py-4 rounded-xl font-semibold hover:bg-red-50 hover:scale-105 transition-all duration-300 flex items-center gap-2 shadow-lg"
                >
              ...
              <div className="flex flex-wrap items-center gap-6 pt-2">
                {[
                  { icon: Building, bold: `${YEARS_EXPERIENCE}+ Years`, sub: "Guiding Professionals" },
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl bg-red-900">
                {!imgError.hero ? (
                  ...
                  <div className="w-full h-[400px] bg-gradient-to-br from-red-800 to-red-900 flex items-center justify-center">
                ...
                <div className="absolute top-4 right-4 bg-white/95 backdrop-blur-sm rounded-xl px-4 py-3 shadow-lg">
                  ...
                  <div className="text-lg font-bold text-red-700">WORK VISA</div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative rounded-2xl overflow-hidden shadow-xl bg-gray-100">
              {!imgError.about ? (
                <Image
                  src="/canadaworkvisa.png"
                  alt="Canada Work Opportunities"
                  width={600}
                  height={400}
                  className="w-full h-[400px] object-contain object-center"
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-600 leading-relaxed">
                Canada is one of the world&apos;s most immigrant-friendly countries, offering excellent work-life balance, 
                high quality of life, and abundant career opportunities. With a strong economy and aging workforce, 
                Canada actively welcomes skilled professionals from around the globe across industries like healthcare, 
                IT, engineering, construction, and finance.
              </p>
              <p className="text-gray-600 leading-relaxed">
                The Canadian work visa program includes options like Express Entry, Provincial Nominee Programs, 
                LMIA-based work permits, and International Experience Canada. Whether you are a skilled worker, 
                tradesperson, or professional, Canada offers a clear pathway to permanent residency. 
                With IIL&apos;s expert guidance, your work visa application process becomes smooth and hassle-free.
              </p>
              <p className="text-gray-600 leading-relaxed">
                From the bustling cities of Toronto and Vancouver to the scenic landscapes of Alberta and Quebec, 
                Canada offers something for everyone. Our team ensures your application is handled professionally 
                so you can focus on your career goals.
              </p>
              <div className="grid grid-cols-2 gap-4 pt-2">
                {[
                  { val: "Ottawa", lbl: "Capital City" },
                  { val: "Canadian Dollar", lbl: "Currency" },
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 max-w-xl mx-auto">
              Key reasons professionals choose Canada for their career
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                icon: Wallet,
                title: "High Salary & Benefits",
                desc: "Canada offers competitive salaries across industries, with strong labour laws ensuring fair pay, overtime compensation, and comprehensive benefits packages.",
              },
              {
                icon: Shield,
                title: "Free Healthcare",
                desc: "Canada&apos;s universal healthcare system provides access to medical services for all residents, significantly reducing personal healthcare costs for workers and families.",
              },
              {
                icon: TrendingUp,
                title: "Path to Permanent Residency",
                desc: "Many Canadian work visas offer clear pathways to permanent residency, allowing you to build a long-term future in Canada with your family.",
              },
              {
                icon: Heart,
                title: "Work-Life Balance",
                desc: "Canadians value work-life balance with reasonable working hours, generous annual leave, parental benefits, and a culture that prioritises family and wellbeing.",
              },
              {
                icon: Users,
                title: "Multicultural Society",
                desc: "Canada is one of the world&apos;s most diverse countries, welcoming professionals from all backgrounds into inclusive and respectful workplaces.",
              },
              {
                icon: GraduationCap,
                title: "Free Education for Kids",
                desc: "Public education in Canada is free up to high school, and the country is home to world-renowned universities offering quality higher education.",
              },
              {
                icon: Star,
                title: "Safe & Secure",
                desc: "Canada consistently ranks among the safest countries in the world, with low crime rates and a stable political environment for families.",
              },
              {
                icon: FileCheck,
                title: "Strong Labour Rights",
                desc: "Canada has robust labour laws protecting worker rights, workplace safety, anti-discrimination policies, and fair employment practices.",
              },
              {
                icon: Globe,
                title: "Quality of Life",
                desc: "From vibrant cities to stunning natural landscapes, Canada offers an exceptional quality of life with clean air, modern amenities, and outdoor recreation.",
              },
        ...
        <div className="container mx-auto px-4">
            ...
            {[
              {
                icon: Compass,
                title: "Visa Guidance",
                desc: "Personalised advice on the right work visa category based on your skills, experience, and career goals.",
              },
              {
                icon: FileText,
              ...
              },
              {
                ...
                desc: "Practical guidance on relocating to Canada, including housing, banking, and local services.",
              },
            ].map(({ icon: Icon, title, desc }, i) => (
              <div
                key={i}
          ...
          <div className="mt-12 bg-red-50 border border-red-100 rounded-2xl p-8 max-w-3xl mx-auto text-center">
            <p className="text-gray-700 text-lg leading-relaxed mb-4">
              ...
              and processing timelines — <span className="font-semibold text-red-800">speak directly with our team.</span>
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a
                href={whatsappLink("Hi, I want to know more about Canada Work Visa.")}
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
            <div className="grid lg:grid-cols-2">
              <div className="bg-red-800 p-8 lg:p-12 text-white">
                <h2 className="text-3xl font-bold mb-3">Apply for Canada<br/>Work Visa</h2>
                ...
                <div className="space-y-5">
                  ...
                  <a href={whatsappLink("Hi, I\'m interested in Canada Work Visa. Please share more information.")} target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 hover:translate-x-1 transition-transform">
                    <div className="w-11 h-11 bg-white/10 rounded-lg flex items-center justify-center shrink-0">
                ...
                <div className="mt-8 pt-6 border-t border-white/20">
                  <div className="flex items-center gap-3 mb-5">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-red-200">Guiding professionals on their visa journey</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
              ...
              <div className="p-8 lg:p-12">
                <form onSubmit={handleSubmit} noValidate className="space-y-5">
                  ...
                  <div>
                    ...
                    <input id="email" name="email" type="email" required autoComplete="email" placeholder="Enter your email address" value={formData.email} onChange={handleInputChange} className={`w-full px-4 py-3 border-2 ${formErrors.email ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : 'border-gray-200 focus:ring-red-500 focus:border-red-500'} rounded-lg outline-none transition-all text-gray-900 placeholder-gray-400`} />
                  ...
                  <div>
                    ...
                    <input id="phone" name="phone" type="tel" required autoComplete="tel" placeholder="Enter your phone number" value={formData.phone} onChange={handleInputChange} className={`w-full px-4 py-3 border-2 ${formErrors.phone ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : 'border-gray-200 focus:ring-red-500 focus:border-red-500'} rounded-lg outline-none transition-all text-gray-900 placeholder-gray-400`} />
                  ...
                  <div>
                    ...
                    <select id="purpose" name="purpose" required value={formData.purpose} onChange={handleInputChange} className={`w-full px-4 py-3 border-2 ${formErrors.purpose ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : 'border-gray-200 focus:ring-red-500 focus:border-red-500'} rounded-lg outline-none transition-all text-gray-900`}>
                      <option value="">Select purpose</option>
                      <option value="express">Express Entry</option>
                      <option value="pnp">Provincial Nominee Program</option>
                      <option value="lmia">LMIA Work Permit</option>
                      <option value="iec">International Experience Canada</option>
                      <option value="transfer">Intra-Company Transfer</option>
                  ...
                  <div>
                    ...
                    <textarea id="message" name="message" rows={3} autoComplete="off" placeholder="Tell us about your skills and experience..." value={formData.message} onChange={handleInputChange} className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none transition-all resize-none text-gray-900 placeholder-gray-400" />
                  </div>
                  <button type="submit" disabled={loading} className="w-full bg-red-700 text-white py-4 rounded-lg font-semibold hover:bg-red-800 active:bg-red-900 transition-colors flex items-center justify-center gap-2 text-lg shadow-md hover:shadow-lg disabled:opacity-60 disabled:cursor-not-allowed">
                    {loading ? (
                  ...
                  <a href={whatsappLink("Hi, I\'m interested in Canada Work Visa. Please share more information.")} target="_blank" rel="noopener noreferrer" className="w-full bg-[#25D366] text-white py-4 rounded-lg font-semibold hover:bg-[#1ebe57] transition-colors flex items-center justify-center gap-2">
      ...
      <section className="relative bg-gradient-to-r from-red-900 via-red-800 to-rose-700 text-white py-16 overflow-hidden">
        <div className="container mx-auto px-4 relative z-10 text-center max-w-3xl mx-auto">
          <h2 className="text-3xl lg:text-4xl font-bold mb-4">
            Start Your Career in <span className="text-rose-200">Canada</span>
          </h2>
          <p className="text-lg text-red-100 mb-8">
            Let IIL guide you toward an exciting career opportunity in Canada. Contact us today!
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <button onClick={() => scrollToSection("enquiry")} className="bg-white text-red-900 px-8 py-4 rounded-xl font-semibold hover:bg-red-50 hover:scale-105 transition-all duration-300 flex items-center gap-2">
              Apply Now <ArrowRight className="w-5 h-5" />
            </button>
            <Link href="/visa/work" className="border-2 border-white/30 text-white px-8 py-4 rounded-xl font-semibold hover:bg-white/10 transition-colors">
              Back to Countries
            </Link>
          </div>
        </div>
