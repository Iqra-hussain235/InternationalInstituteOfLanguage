...
import {
  ...
  GraduationCap, Euro, Factory, Wrench,
...
const UKWorkPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Floating WhatsApp */}
      <a
        href={whatsappLink("Hi, I'm interested in UK Work Visa. Please share more information.")}
        target="_blank"
        ...
        >
          ...
          >
            ...
            <div className="flex gap-3">
              <a
                href={whatsappLink("Hi, I just submitted an enquiry for UK Work Visa. Please assist me further.")}
                target="_blank"
                rel="noopener noreferrer"
              ...
              <button
                onClick={closePopup}
                className="flex-1 bg-red-800 text-white px-4 py-3 rounded-lg hover:bg-red-900 transition-colors font-semibold"
              >
                Close
              </button>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
                Work in <span className="block text-red-200">United Kingdom</span>
              </h1>
              <p className="text-lg text-red-100 leading-relaxed max-w-xl">
                Build your career in one of the world&apos;s most dynamic economies.
                The UK offers excellent career opportunities, world-class healthcare,
                and a rich cultural experience for skilled professionals from around the globe.
              </p>
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl bg-red-900">
                {/* ✅ SWAPPED: Hero mein ab unitedkingdomvisitimage.png hai */}
                {!imgError.hero ? (
                  <Image
                    src="/unitedkingdomvisitimage.png"
                    alt="Work in United Kingdom"
                    width={600}
                    height={400}
      ...
      {/* ═══════════════════════════════════════
          ABOUT UK WORK SECTION
          ═══════════════════════════════════════ */}
      <section className="py-16 lg:py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative rounded-2xl overflow-hidden shadow-xl bg-gray-100">
              {/* ✅ SWAPPED: About mein ab unitedkingdomvisit.png hai */}
              {!imgError.about ? (
                <Image
                  src="/unitedkingdomvisit.png"
                  alt="United Kingdom Work Opportunities"
                  width={600}
                  height={400}
                  className="w-full h-[400px] object-contain object-center"
            ...
            <div className="space-y-6">
              ...
              <h2 className="text-3xl lg:text-4xl font-bold text-gray-900">
                Build Your Career in the United Kingdom
              </h2>
              <p className="text-gray-600 leading-relaxed">
                The United Kingdom is one of the world&apos;s leading economies, offering
                excellent career opportunities, competitive salaries, and a high standard of living.
                With London as a global financial hub and thriving tech, healthcare, and creative sectors,
                the UK actively welcomes skilled professionals from around the world.
              </p>
              <p className="text-gray-600 leading-relaxed">
                The UK work visa program includes the Skilled Worker Visa,
                Health and Care Worker Visa, Global Talent Visa, and Graduate Visa.
                Whether you are a healthcare professional, engineer, IT specialist, or academic researcher,
                the UK offers a clear pathway to build your career and eventually settle permanently.
              </p>
              <p className="text-gray-600 leading-relaxed">
                With IIL&apos;s expert guidance, your work visa application process becomes smooth and hassle-free.
                Our team ensures your application is handled professionally so you can focus on your career goals.
              </p>
              <div className="grid grid-cols-2 gap-4 pt-2">
                {[
                  ...
                  { val: "Northwest Europe", lbl: "Location" },
                ].map(({ val, lbl }, i) => (
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 max-w-xl mx-auto">
              Key reasons professionals choose the UK for their career
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Competitive wages and comprehensive employment benefits packages across all major industries.",
              },
              {
                icon: Shield,
                title: "NHS Healthcare Access",
                desc: "Access to the National Health Service, one of the world&apos;s leading public healthcare systems.",
              },
              {
                icon: TrendingUp,
                title: "Path to Settlement",
                desc: "Clear pathways from work visa to permanent residency and eventual British citizenship.",
              },
              {
                icon: Heart,
                title: "Multicultural Society",
                desc: "A diverse, inclusive environment welcoming professionals from every corner of the world.",
              },
              {
                icon: Factory,
                title: "Global Financial Hub",
                desc: "London and other cities offer world-leading opportunities in finance, tech, and creative industries.",
              },
              {
                icon: GraduationCap,
                title: "World-Class Education",
                desc: "Excellent schools and universities for your children, with globally recognized qualifications.",
              },
              {
                icon: Users,
                title: "Career Growth",
                desc: "Abundant opportunities for professional development, networking, and advancement.",
              },
              {
                icon: FileCheck,
                title: "Worker Protections",
                desc: "Strong labor laws ensuring fair treatment, workplace safety, and employee rights.",
              },
              {
                icon: Star,
                title: "Quality of Life",
                desc: "Rich cultural heritage, excellent public services, and vibrant city life balanced with green spaces.",
              },
        ...
        <div className="container mx-auto px-4">
            ...
            {[
              {
                icon: Compass,
                title: "Visa Guidance",
                desc: "Personalised advice on the right UK work visa category based on your skills, experience, and career goals.",
              },
              {
                icon: FileText,
          ...
          <div className="mt-12 bg-red-50 border border-red-100 rounded-2xl p-8 max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <button
                onClick={() => scrollToSection("enquiry")}
                className="bg-red-800 text-white px-7 py-3 rounded-xl font-semibold hover:bg-red-900 hover:scale-105 transition-all duration-300 flex items-center gap-2"
              >
                Send an Enquiry <ArrowRight className="w-4 h-4" />
              </button>
              <a
                href={whatsappLink("Hi, I want to know more about UK Work Visa.")}
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
            <div className="grid lg:grid-cols-2">
              <div className="bg-red-900 p-8 lg:p-12 text-white">
                <h2 className="text-3xl font-bold mb-3">Apply for United Kingdom<br/>Work Visa</h2>
                ...
                <div className="space-y-5">
                  ...
                  <a href={whatsappLink("Hi, I'm interested in UK Work Visa. Please share more information.")} target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 hover:translate-x-1 transition-transform">
                    <div className="w-11 h-11 bg-white/10 rounded-lg flex items-center justify-center shrink-0">
                ...
                <div className="mt-8 pt-6 border-t border-white/20">
                  <div className="flex items-center gap-3 mb-5">
                    <Award className="w-7 h-7 text-red-300 shrink-0" />
                    <div>
                ...
                <form onSubmit={handleSubmit} noValidate className="space-y-5">
                  ...
                  <div>
                    ...
                    <select id="purpose" name="purpose" required value={formData.purpose} onChange={handleInputChange} className={`w-full px-4 py-3 border-2 ${formErrors.purpose ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : 'border-gray-200 focus:ring-red-500 focus:border-red-500'} rounded-lg outline-none transition-all text-gray-900`}>
                      ...
                      <option value="health-care">Health and Care Worker Visa</option>
                  ...
                  <button type="submit" disabled={loading} className="w-full bg-red-800 text-white py-4 rounded-lg font-semibold hover:bg-red-900 active:bg-red-950 transition-colors flex items-center justify-center gap-2 text-lg shadow-md hover:shadow-lg disabled:opacity-60 disabled:cursor-not-allowed">
                    {loading ? (
                  ...
                  <a href={whatsappLink("Hi, I'm interested in UK Work Visa. Please share more information.")} target="_blank" rel="noopener noreferrer" className="w-full bg-[#25D366] text-white py-4 rounded-lg font-semibold hover:bg-[#1ebe57] transition-colors flex items-center justify-center gap-2">
      ...
      <section className="relative bg-gradient-to-r from-red-900 via-red-800 to-rose-700 text-white py-16 overflow-hidden">
        <div className="container mx-auto px-4 relative z-10 text-center max-w-3xl mx-auto">
          <h2 className="text-3xl lg:text-4xl font-bold mb-4">
            Start Your Career in the <span className="text-red-200">United Kingdom</span>
          </h2>
          <p className="text-lg text-red-100 mb-8">
            Let IIL guide you toward an exciting career opportunity in the UK. Contact us today!
          </p>
          <div className="flex flex-wrap justify-center gap-4">
