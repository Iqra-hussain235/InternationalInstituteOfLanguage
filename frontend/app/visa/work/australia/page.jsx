...
const AustraliaWorkPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Floating WhatsApp */}
      <a
        href={whatsappLink("Hi, I\'m interested in Australia Work Visa. Please share more information.")}
        target="_blank"
        ...
        >
          ...
          >
            ...
            <div className="flex gap-3">
              <a
                href={whatsappLink("Hi, I just submitted an enquiry for Australia Work Visa. Please assist me further.")}
                target="_blank"
                rel="noopener noreferrer"
              ...
              <button
                onClick={closePopup}
                className="flex-1 bg-blue-700 text-white px-4 py-3 rounded-lg hover:bg-blue-800 transition-colors font-semibold"
              >
                Close
              </button>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
                Work in <span className="block text-sky-200">Australia</span>
              </h1>
              <p className="text-lg text-blue-100 leading-relaxed max-w-xl">
                Australia offers excellent opportunities for skilled professionals. 
                An Australian Work Visa lets you build your career in one of the world&apos;s 
                strongest economies. Let IIL guide you through the process.
              </p>
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl bg-blue-900">
                {!imgError.hero ? (
                  <Image
                    src="/australiaworkimage.png"
                    alt="Work in Australia"
                    width={600}
                    height={400}
                ...
                <div className="absolute top-4 right-4 bg-white/95 backdrop-blur-sm rounded-xl px-4 py-3 shadow-lg">
                  ...
                  <div className="text-lg font-bold text-blue-700">WORK VISA</div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative rounded-2xl overflow-hidden shadow-xl bg-gray-100">
              {!imgError.about ? (
                <Image
                  src="/australiaworkvisa.png"
                  alt="Australia Work Opportunities"
                  width={600}
                  height={400}
                  className="w-full h-[400px] object-contain object-center"
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-600 leading-relaxed">
                Australia is one of the most sought-after destinations for skilled workers worldwide. 
                With a strong economy, high standard of living, and excellent work-life balance, 
                Australia offers incredible opportunities for professionals across various industries 
                including healthcare, IT, engineering, construction, and hospitality.
              </p>
              <p className="text-gray-600 leading-relaxed">
                The Australian work visa program allows skilled workers to live and work in Australia 
                temporarily or permanently. Whether you are a skilled professional, tradesperson, 
                or business owner, Australia has a visa pathway for you. With IIL&apos;s expert guidance, 
                your work visa application process becomes smooth and hassle-free.
              </p>
              <p className="text-gray-600 leading-relaxed">
                From the Temporary Skill Shortage Visa to the Skilled Independent Visa, we help you 
                understand the right pathway for your skills and experience. Our team ensures your 
                application is handled professionally so you can focus on your career goals.
              </p>
              <div className="grid grid-cols-2 gap-4 pt-2">
                {[
                  { val: "Canberra", lbl: "Capital City" },
                  { val: "Australian Dollar", lbl: "Currency" },
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 max-w-xl mx-auto">
              Key reasons professionals choose Australia for their career
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Australia offers competitive salaries across industries, with strong minimum wage laws and excellent earning potential for skilled professionals.",
              },
              {
                icon: Shield,
                title: "Safe Work Environment",
                desc: "Australia has strict workplace safety laws and regulations, ensuring a secure and healthy working environment for all employees.",
              },
              {
                icon: TrendingUp,
                title: "Career Growth",
                desc: "With a growing economy and skills shortage in many sectors, Australia offers excellent opportunities for career advancement and professional development.",
              },
              {
                icon: Heart,
                title: "Work-Life Balance",
                desc: "Australians value work-life balance with reasonable working hours, generous annual leave, and a culture that prioritises personal wellbeing.",
              },
              {
                icon: Star,
                title: "World-Class Healthcare",
                desc: "Australia&apos;s Medicare system provides access to quality healthcare, and many employers offer additional private health insurance benefits.",
              },
              {
                icon: Globe,
                title: "Path to Permanent Residency",
                desc: "Many Australian work visas offer pathways to permanent residency, allowing you to build a long-term future in Australia with your family.",
              },
              {
                icon: Users,
                title: "Multicultural Workplace",
                desc: "Australia&apos;s diverse and inclusive workplaces welcome professionals from all backgrounds, creating a rich and collaborative work culture.",
              },
              {
                icon: FileCheck,
                title: "Strong Labour Rights",
                desc: "Australia has robust labour laws protecting worker rights, fair pay, and equal opportunity employment across all industries.",
              },
              {
                icon: Sun,
                title: "Quality of Life",
                desc: "From beautiful beaches to vibrant cities, Australia offers an exceptional quality of life with great weather, outdoor activities, and modern amenities.",
              },
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-12 bg-blue-50 border border-blue-100 rounded-2xl p-8 max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <button
                onClick={() => scrollToSection("enquiry")}
                className="bg-blue-700 text-white px-7 py-3 rounded-xl font-semibold hover:bg-blue-800 hover:scale-105 transition-all duration-300 flex items-center gap-2"
              >
                Send an Enquiry <ArrowRight className="w-4 h-4" />
              </button>
              <a
                href={whatsappLink("Hi, I want to know more about Australia Work Visa.")}
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
            <div className="grid lg:grid-cols-2">
              <div className="bg-blue-800 p-8 lg:p-12 text-white">
                <h2 className="text-3xl font-bold mb-3">Apply for Australia<br/>Work Visa</h2>
                ...
                <div className="space-y-5">
                  ...
                  <a href={whatsappLink("Hi, I\'m interested in Australia Work Visa. Please share more information.")} target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 hover:translate-x-1 transition-transform">
                    <div className="w-11 h-11 bg-white/10 rounded-lg flex items-center justify-center shrink-0">
                ...
                <div className="mt-8 pt-6 border-t border-white/20">
                  <div className="flex items-center gap-3 mb-5">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-blue-200">Guiding professionals on their visa journey</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                ...
                <form onSubmit={handleSubmit} noValidate className="space-y-5">
                  ...
                  <div>
                    ...
                    <select id="purpose" name="purpose" required value={formData.purpose} onChange={handleInputChange} className={`w-full px-4 py-3 border-2 ${formErrors.purpose ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : 'border-gray-200 focus:ring-blue-500 focus:border-blue-500'} rounded-lg outline-none transition-all text-gray-900`}>
                      ...
                      <option value="regional">Regional Work Visa</option>
                      <option value="holiday">Working Holiday</option>
                  ...
                  <div>
                    ...
                    <textarea id="message" name="message" rows={3} autoComplete="off" placeholder="Tell us about your skills and experience..." value={formData.message} onChange={handleInputChange} className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all resize-none text-gray-900 placeholder-gray-400" />
                  </div>
                  <button type="submit" disabled={loading} className="w-full bg-blue-700 text-white py-4 rounded-lg font-semibold hover:bg-blue-800 active:bg-blue-900 transition-colors flex items-center justify-center gap-2 text-lg shadow-md hover:shadow-lg disabled:opacity-60 disabled:cursor-not-allowed">
                    {loading ? (
                  ...
                  <a href={whatsappLink("Hi, I\'m interested in Australia Work Visa. Please share more information.")} target="_blank" rel="noopener noreferrer" className="w-full bg-[#25D366] text-white py-4 rounded-lg font-semibold hover:bg-[#1ebe57] transition-colors flex items-center justify-center gap-2">
      ...
      <section className="relative bg-gradient-to-r from-blue-900 via-blue-800 to-sky-700 text-white py-16 overflow-hidden">
        <div className="container mx-auto px-4 relative z-10 text-center max-w-3xl mx-auto">
          <h2 className="text-3xl lg:text-4xl font-bold mb-4">
            Start Your Career in <span className="text-sky-200">Australia</span>
          </h2>
          <p className="text-lg text-blue-100 mb-8">
            Let IIL guide you toward an exciting career opportunity in Australia. Contact us today!
          </p>
          <div className="flex flex-wrap justify-center gap-4">
...
export default AustraliaWorkPage;