...
const GermanyWorkPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Floating WhatsApp */}
      <a
        href={whatsappLink("Hi, I'm interested in Germany Work Visa. Please share more information.")}
        target="_blank"
        ...
        >
          ...
          >
            ...
            <div className="flex gap-3">
              <a
                href={whatsappLink("Hi, I just submitted an enquiry for Germany Work Visa. Please assist me further.")}
                target="_blank"
                rel="noopener noreferrer"
      ...
      {/* HERO SECTION — RED/AMBER THEME */}
      <section className="relative bg-gradient-to-br from-red-900 via-red-800 to-amber-700 text-white overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
                Work in <span className="block text-amber-200">Germany</span>
              </h1>
              <p className="text-lg text-red-100 leading-relaxed max-w-xl">
                Build your career in Europe's largest economy. Germany offers world-class opportunities 
                for skilled professionals with strong industries, excellent benefits, and a high quality of life. 
                Let IIL guide you through the process.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative rounded-2xl overflow-hidden shadow-xl bg-gray-100">
              {!imgError.about ? (
                <Image
                  src="/germanyworkvisaimage.png"
                  alt="Germany Work Opportunities"
                  width={600}
                  height={400}
                  className="w-full h-[400px] object-contain object-center"
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-600 leading-relaxed">
                Germany is Europe's largest economy and one of the world's most attractive destinations 
                for skilled workers. With a strong industrial base, excellent infrastructure, and 
                high quality of life, Germany offers incredible career opportunities across various sectors.
              </p>
              <p className="text-gray-600 leading-relaxed">
                The German work visa program welcomes skilled professionals from around the world. 
                Whether you are an engineer, IT specialist, healthcare worker, or skilled tradesperson, 
                Germany has a pathway for you to build your career.
              </p>
              <p className="text-gray-600 leading-relaxed">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 max-w-xl mx-auto">
              Key reasons professionals choose Germany for their career
            </p>
          </div>
            ...
            {[
              {
                icon: Wallet,
                title: "High Salary",
                desc: "Competitive wages and excellent benefits packages across all industries in Germany.",
              },
              {
                icon: Shield,
                title: "Social Security",
                desc: "Comprehensive social security system including health, pension, and unemployment benefits.",
              },
              {
                icon: TrendingUp,
                title: "Career Growth",
                desc: "Strong economy with abundant opportunities for professional advancement and skill development.",
              },
              {
                icon: Heart,
                title: "Work-Life Balance",
                desc: "Generous vacation policies and strong labor protections ensuring a healthy work-life balance.",
              },
              {
                icon: Factory,
                title: "Strong Industries",
                desc: "World-leading automotive, engineering, IT, and manufacturing sectors driving innovation.",
              },
              {
                icon: GraduationCap,
                title: "Free Education",
                desc: "Quality public education and world-class universities for your children at no cost.",
              },
              {
                icon: Users,
                title: "Multicultural",
                desc: "Welcoming environment with a large international professional community from around the world.",
              },
              {
                icon: FileCheck,
                title: "Worker Rights",
                desc: "Strong labor laws protecting employee rights, workplace safety, and fair treatment.",
              },
              {
                icon: Star,
                title: "Quality of Life",
                desc: "Excellent healthcare, infrastructure, and cultural experiences for you and your family.",
              },
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {[
              ...
              },
              {
                ...
                desc: "Practical guidance on relocating to Germany, including housing, banking, and local services.",
              },
            ].map(({ icon: Icon, title, desc }, i) => (
              <div
                key={i}
          ...
          <div className="mt-12 bg-red-50 border border-red-100 rounded-2xl p-8 max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a
                href={whatsappLink("Hi, I want to know more about Germany Work Visa.")}
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
            <div className="grid lg:grid-cols-2">
              <div className="bg-red-800 p-8 lg:p-12 text-white">
                <h2 className="text-3xl font-bold mb-3">Apply for Germany<br/>Work Visa</h2>
                ...
                <div className="space-y-5">
                  ...
                  <a href={whatsappLink("Hi, I'm interested in Germany Work Visa. Please share more information.")} target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 hover:translate-x-1 transition-transform">
                    <div className="w-11 h-11 bg-white/10 rounded-lg flex items-center justify-center shrink-0">
                ...
                <form onSubmit={handleSubmit} noValidate className="space-y-5">
                  ...
                  <div>
                    ...
                    <select id="purpose" name="purpose" required value={formData.purpose} onChange={handleInputChange} className={`w-full px-4 py-3 border-2 ${formErrors.purpose ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : 'border-gray-200 focus:ring-red-500 focus:border-red-500'} rounded-lg outline-none transition-all text-gray-900`}>
                      ...
                      <option value="job-seeker">Job Seeker Visa</option>
                      <option value="ict">ICT Card</option>
                  ...
                  <a href={whatsappLink("Hi, I'm interested in Germany Work Visa. Please share more information.")} target="_blank" rel="noopener noreferrer" className="w-full bg-[#25D366] text-white py-4 rounded-lg font-semibold hover:bg-[#1ebe57] transition-colors flex items-center justify-center gap-2">
      ...
      <section className="relative bg-gradient-to-r from-red-900 via-red-800 to-amber-700 text-white py-16 overflow-hidden">
        <div className="container mx-auto px-4 relative z-10 text-center max-w-3xl mx-auto">
          <h2 className="text-3xl lg:text-4xl font-bold mb-4">
            Start Your Career in <span className="text-amber-200">Germany</span>
          </h2>
          <p className="text-lg text-red-100 mb-8">
            Let IIL guide you toward an exciting career opportunity in Germany. Contact us today!
          </p>
          <div className="flex flex-wrap justify-center gap-4">
