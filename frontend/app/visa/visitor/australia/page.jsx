...
import {
  ...
  Camera, Sun, Star, MapPinned, Palmtree,
  Waves, Mountain, Utensils, Music
} from "lucide-react";
...
const AustraliaVisitorPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Floating WhatsApp */}
      <a
        href={whatsappLink("Hi, I'm interested in Australia Visitor Visa. Please share more information.")}
        target="_blank"
        ...
        >
          ...
          >
            ...
            <div className="flex gap-3">
              <a
                href={whatsappLink("Hi, I just submitted an enquiry for Australia Visitor Visa. Please assist me further.")}
                target="_blank"
                rel="noopener noreferrer"
      ...
      {/* ═══════════════════════════════════════
          ...
          ═══════════════════════════════════════ */}
      <section className="relative bg-gradient-to-br from-teal-900 via-teal-800 to-emerald-700 text-white overflow-hidden">
        <div className="absolute -top-24 -right-24 w-96 h-96 bg-teal-400/10 rounded-full blur-3xl pointer-events-none" />
        <div className="absolute -bottom-24 -left-24 w-96 h-96 bg-emerald-300/10 rounded-full blur-3xl pointer-events-none" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
                Visit <span className="block text-teal-200">Australia</span>
              </h1>
              <p className="text-lg text-teal-100 leading-relaxed max-w-xl">
                Discover stunning beaches, vibrant cities, and unique wildlife. 
                An Australia Visitor Visa lets you explore this incredible destination for tourism, 
                family visits, or short business trips.
              </p>
              <div className="flex flex-wrap gap-4">
                <button
                  onClick={() => scrollToSection("enquiry")}
                  className="bg-white text-teal-900 px-8 py-4 rounded-xl font-semibold hover:bg-teal-50 hover:scale-105 transition-all duration-300 flex items-center gap-2 shadow-lg"
                >
                ...
                {[
                  ...
                  <div key={i} className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-teal-200">{sub}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl bg-teal-900">
                {!imgError.hero ? (
                  ...
                  <div className="w-full h-[400px] bg-gradient-to-br from-teal-800 to-emerald-900 flex items-center justify-center">
                    <Palmtree className="w-32 h-32 text-white/20" />
                  </div>
                )}
                ...
                <div className="absolute top-4 right-4 bg-white/95 backdrop-blur-sm rounded-xl px-4 py-3 shadow-lg">
                  ...
                  <div className="text-lg font-bold text-teal-700">VISITOR VISA</div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative rounded-2xl overflow-hidden shadow-xl bg-gray-100">
              {!imgError.about ? (
                <Image
                  src="/australiaimagevisitorvisa.png"
                ...
                <div className="w-full h-[400px] bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center">
                  <Palmtree className="w-32 h-32 text-gray-400" />
                </div>
              )}
            </div>
            <div className="space-y-6">
              ...
              <p className="text-gray-600 leading-relaxed">
                Australia is a land of breathtaking diversity — from the Great Barrier Reef and Outback deserts 
                to cosmopolitan cities like Sydney and Melbourne. Experience world-class beaches, unique wildlife, 
                and a laid-back lifestyle that makes Australia a dream destination for travellers from around the world.
              </p>
              <p className="text-gray-600 leading-relaxed">
                An Australian Visitor Visa allows you to explore this incredible country for tourism, visit family and friends, 
                or attend short-term business events. With IIL&apos;s expert visa consultants, your journey Down Under becomes 
                seamless and stress-free.
              </p>
              <p className="text-gray-600 leading-relaxed">
                Whether you want to see the Sydney Opera House, snorkel in the Great Barrier Reef, or reunite with loved ones, 
                Australia offers unforgettable experiences. Our team ensures your visa process is handled professionally 
                so you can focus on planning your trip.
              </p>
              <div className="grid grid-cols-2 gap-4 pt-2">
                {[
                  { val: "Canberra", lbl: "Capital City" },
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 max-w-xl mx-auto">
              Key reasons travellers choose Australia as their destination
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "From the Great Barrier Reef to Uluru and pristine beaches, Australia offers some of the world's most spectacular natural landscapes.",
              },
              {
                icon: Camera,
                title: "Iconic Landmarks",
                desc: "Visit world-famous sites like the Sydney Opera House, Harbour Bridge, Great Ocean Road, and Bondi Beach.",
              },
              {
                icon: Users,
                title: "Family & Friends Visits",
                desc: "Reunite with loved ones living in Australia. A visitor visa makes it easy to spend quality time with family and friends.",
              },
              {
                icon: Briefcase,
                title: "Short Business Trips",
                desc: "Attend conferences, meetings, or explore business opportunities in Australia's thriving economy.",
              },
              {
                icon: Waves,
                title: "Unique Wildlife",
                desc: "Experience Australia's incredible wildlife — kangaroos, koalas, and marine life found nowhere else on Earth.",
              },
              {
                icon: Star,
                title: "World-Class Cities",
                desc: "Sydney, Melbourne, Brisbane, and Perth offer vibrant culture, excellent food scenes, shopping, and entertainment.",
              },
              {
                icon: Mountain,
                title: "Adventure & Activities",
                desc: "From surfing and diving to hiking and desert safaris, Australia offers endless adventure activities.",
              },
              {
                icon: Shield,
                title: "Safe & Welcoming",
                desc: "Australia is known for being a safe, friendly, and welcoming destination with excellent infrastructure.",
              },
              {
                icon: Utensils,
                title: "Rich Culture & Food",
                desc: "Explore Indigenous Australian culture, modern art galleries, museums, and a diverse multicultural food scene.",
              },
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {[
              ...
              },
              {
                ...
                desc: "Practical guidance on travel planning, insurance, and tips for a hassle-free Australian trip.",
              },
            ].map(({ icon: Icon, title, desc }, i) => (
              <div
                key={i}
          ...
          <div className="mt-12 bg-teal-50 border border-teal-100 rounded-2xl p-8 max-w-3xl mx-auto text-center">
            <p className="text-gray-700 text-lg leading-relaxed mb-4">
              ...
              and processing timelines — <span className="font-semibold text-teal-800">speak directly with our team.</span>
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a
                href={whatsappLink("Hi, I want to know more about Australia Visitor Visa.")}
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
            <div className="grid lg:grid-cols-2">
              <div className="bg-teal-800 p-8 lg:p-12 text-white">
                <h2 className="text-3xl font-bold mb-3">Apply for Australia<br/>Visitor Visa</h2>
                ...
                <div className="space-y-5">
                  ...
                  <a href={whatsappLink("Hi, I'm interested in Australia Visitor Visa. Please share more information.")} target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 hover:translate-x-1 transition-transform">
                    <div className="w-11 h-11 bg-white/10 rounded-lg flex items-center justify-center shrink-0">
                ...
                <div className="mt-8 pt-6 border-t border-white/20">
                  <div className="flex items-center gap-3 mb-5">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-teal-200">Guiding travellers on their visa journey</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
              ...
              <div className="p-8 lg:p-12">
                <form onSubmit={handleSubmit} noValidate className="space-y-5">
                  ...
                  <div>
                    ...
                    <textarea id="message" name="message" rows={3} autoComplete="off" placeholder="Tell us about your travel plans..." value={formData.message} onChange={handleInputChange} className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 outline-none transition-all resize-none text-gray-900 placeholder-gray-400" />
                  </div>
                  <button type="submit" disabled={loading} className="w-full bg-teal-700 text-white py-4 rounded-lg font-semibold hover:bg-teal-800 active:bg-teal-900 transition-colors flex items-center justify-center gap-2 text-lg shadow-md hover:shadow-lg disabled:opacity-60 disabled:cursor-not-allowed">
                    {loading ? (
                  ...
                  <a href={whatsappLink("Hi, I'm interested in Australia Visitor Visa. Please share more information.")} target="_blank" rel="noopener noreferrer" className="w-full bg-[#25D366] text-white py-4 rounded-lg font-semibold hover:bg-[#1ebe57] transition-colors flex items-center justify-center gap-2">
      ...
      {/* ═══════════════════════════════════════
          ...
          ═══════════════════════════════════════ */}
      <section className="relative bg-gradient-to-r from-teal-900 via-teal-800 to-emerald-700 text-white py-16 overflow-hidden">
        <div className="container mx-auto px-4 relative z-10 text-center max-w-3xl mx-auto">
          <h2 className="text-3xl lg:text-4xl font-bold mb-4">
            Start Your Journey to <span className="text-teal-200">Australia</span>
          </h2>
          <p className="text-lg text-teal-100 mb-8">
            Let IIL guide you toward an unforgettable Australian experience. Contact us today!
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <button onClick={() => scrollToSection("enquiry")} className="bg-white text-teal-900 px-8 py-4 rounded-xl font-semibold hover:bg-teal-50 hover:scale-105 transition-all duration-300 flex items-center gap-2">
...
export default AustraliaVisitorPage;