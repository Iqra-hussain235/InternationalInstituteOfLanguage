...
import {
  ...
  Camera, Star, Sparkles, ShoppingBag, Utensils,
  Sun, LandmarkIcon
} from "lucide-react";
...
const DubaiVisitorPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Floating WhatsApp */}
      <a
        href={whatsappLink("Hi, I\'m interested in Dubai Visitor Visa. Please share more information.")}
        target="_blank"
        ...
        >
          ...
          >
            ...
            <div className="flex gap-3">
              <a
                href={whatsappLink("Hi, I just submitted an enquiry for Dubai Visitor Visa. Please assist me further.")}
                target="_blank"
                rel="noopener noreferrer"
              ...
              <button
                onClick={closePopup}
                className="flex-1 bg-amber-700 text-white px-4 py-3 rounded-lg hover:bg-amber-800 transition-colors font-semibold"
              >
                Close
              </button>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
                Visit <span className="block text-amber-200">Dubai</span>
              </h1>
              <p className="text-lg text-amber-100 leading-relaxed max-w-xl">
                Experience luxury, innovation, and world-class attractions in Dubai. 
                A visitor visa lets you explore the UAE&apos;s most iconic city for tourism, 
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl bg-amber-900">
                {!imgError.hero ? (
                  ...
                  <div className="w-full h-[400px] bg-gradient-to-br from-amber-800 to-yellow-900 flex items-center justify-center">
                    <Sun className="w-32 h-32 text-white/20" />
                  </div>
                )}
                ...
                <div className="absolute top-4 right-4 bg-white/95 backdrop-blur-sm rounded-xl px-4 py-3 shadow-lg">
                  ...
                  <div className="text-lg font-bold text-amber-700">VISITOR VISA</div>
                </div>
              </div>
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-xl bg-gray-100">
              {!imgError.about ? (
                ...
                <div className="w-full h-[400px] bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center">
                  <LandmarkIcon className="w-32 h-32 text-gray-400" />
                </div>
              )}
            </div>
            <div className="space-y-6">
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                and most luxurious hotels. From desert safaris to skydiving over Palm Jumeirah, Dubai offers 
                unforgettable experiences for every traveler seeking adventure, luxury, and culture.
              </p>
              <p className="text-gray-600 leading-relaxed">
                A Dubai Visitor Visa allows you to explore this futuristic city for tourism, visit family and friends, 
                or attend short-term business events. With IIL&apos;s expert visa consultants, your UAE journey becomes 
                seamless and stress-free. We help you understand the requirements and prepare your application correctly.
              </p>
              <p className="text-gray-600 leading-relaxed">
                Whether you want to see the Burj Khalifa, shop at Dubai Mall, or experience a traditional desert safari, 
                Dubai offers experiences that blend modern luxury with rich heritage. Our team ensures your visa process 
                is handled professionally so you can focus on planning your trip.
              </p>
              <div className="grid grid-cols-2 gap-4 pt-2">
                {[
                  { val: "Dubai", lbl: "City & Emirate" },
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 max-w-xl mx-auto">
              Key reasons travellers choose Dubai as their destination
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Marvel at the Burj Khalifa, Palm Jumeirah, and Burj Al Arab. Dubai&apos;s skyline is a testament to human ambition and architectural brilliance.",
              },
              {
                icon: ShoppingBag,
                title: "World-Class Shopping",
                desc: "From Dubai Mall and Mall of the Emirates to traditional souks, Dubai offers unparalleled shopping experiences for every budget and taste.",
              },
              {
                icon: Users,
                title: "Family & Friends Visits",
                desc: "Reunite with loved ones living in Dubai. A visitor visa makes it easy to spend quality time with family and friends in the UAE.",
              },
              {
                icon: Briefcase,
                title: "Business Hub",
                desc: "Attend conferences, exhibitions, or explore business opportunities in one of the world&apos;s fastest-growing commercial and trade centers.",
              },
              {
                icon: Utensils,
                title: "Culinary Excellence",
                desc: "Experience world-class dining from Michelin-starred restaurants to authentic Middle Eastern cuisine. Dubai is a food lover&apos;s paradise.",
              },
              {
                icon: Star,
                title: "Luxury & Hospitality",
                desc: "Enjoy world-renowned luxury hotels, pristine beaches, and exceptional service that makes Dubai a top destination for discerning travelers.",
              },
              {
                icon: Camera,
                title: "Adventure Activities",
                desc: "From desert safaris and dune bashing to skydiving and water sports, Dubai offers thrilling activities for adventure enthusiasts.",
              },
              {
                icon: Shield,
                title: "Safe & Modern",
                desc: "Dubai is one of the safest cities in the world with excellent infrastructure, healthcare, and transportation systems for visitors.",
              },
              {
                icon: BookOpen,
                title: "Rich Heritage & Culture",
                desc: "Explore traditional markets, historic districts, and cultural centers that showcase the UAE&apos;s rich Bedouin heritage and modern evolution.",
              },
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {[
              ...
              },
              {
                ...
                desc: "Practical guidance on travel planning, insurance, and tips for a hassle-free Dubai trip.",
              },
            ].map(({ icon: Icon, title, desc }, i) => (
              <div
                key={i}
          ...
          <div className="mt-12 bg-amber-50 border border-amber-100 rounded-2xl p-8 max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <button
                onClick={() => scrollToSection("enquiry")}
                className="bg-amber-700 text-white px-7 py-3 rounded-xl font-semibold hover:bg-amber-800 hover:scale-105 transition-all duration-300 flex items-center gap-2"
              >
                Send an Enquiry <ArrowRight className="w-4 h-4" />
              </button>
              <a
                href={whatsappLink("Hi, I want to know more about Dubai Visitor Visa.")}
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
            <div className="grid lg:grid-cols-2">
              <div className="bg-amber-800 p-8 lg:p-12 text-white">
                <h2 className="text-3xl font-bold mb-3">Apply for Dubai<br/>Visitor Visa</h2>
                ...
                <div className="space-y-5">
                  ...
                  <a href={whatsappLink("Hi, I\'m interested in Dubai Visitor Visa. Please share more information.")} target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 hover:translate-x-1 transition-transform">
                    <div className="w-11 h-11 bg-white/10 rounded-lg flex items-center justify-center shrink-0">
                ...
                <div className="mt-8 pt-6 border-t border-white/20">
                  <div className="flex items-center gap-3 mb-5">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-amber-200">Guiding travellers on their visa journey</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
              ...
              <div className="p-8 lg:p-12">
                <form onSubmit={handleSubmit} noValidate className="space-y-5">
                  ...
                  <div>
                    ...
                    <textarea id="message" name="message" rows={3} autoComplete="off" placeholder="Tell us about your travel plans..." value={formData.message} onChange={handleInputChange} className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none transition-all resize-none text-gray-900 placeholder-gray-400" />
                  </div>
                  <button type="submit" disabled={loading} className="w-full bg-amber-700 text-white py-4 rounded-lg font-semibold hover:bg-amber-800 active:bg-amber-900 transition-colors flex items-center justify-center gap-2 text-lg shadow-md hover:shadow-lg disabled:opacity-60 disabled:cursor-not-allowed">
                    {loading ? (
                  ...
                  <a href={whatsappLink("Hi, I\'m interested in Dubai Visitor Visa. Please share more information.")} target="_blank" rel="noopener noreferrer" className="w-full bg-[#25D366] text-white py-4 rounded-lg font-semibold hover:bg-[#1ebe57] transition-colors flex items-center justify-center gap-2">
      ...
      {/* ═══════════════════════════════════════
          ...
          ═══════════════════════════════════════ */}
      <section className="relative bg-gradient-to-r from-amber-900 via-amber-800 to-yellow-700 text-white py-16 overflow-hidden">
        <div className="container mx-auto px-4 relative z-10 text-center max-w-3xl mx-auto">
          <h2 className="text-3xl lg:text-4xl font-bold mb-4">
            Start Your Journey to <span className="text-amber-200">Dubai</span>
          </h2>
          <p className="text-lg text-amber-100 mb-8">
            Let IIL guide you toward an unforgettable Dubai experience. Contact us today!
          </p>
          <div className="flex flex-wrap justify-center gap-4">
...
export default DubaiVisitorPage;