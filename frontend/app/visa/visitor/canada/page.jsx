...
import {
  ...
  Camera, Mountain, Star, Snowflake, TreePine, Map
} from "lucide-react";
...
const CanadaVisitorPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Floating WhatsApp */}
      <a
        href={whatsappLink("Hi, I\'m interested in Canada Visitor Visa. Please share more information.")}
        target="_blank"
        ...
        >
          ...
          >
            ...
            <div className="flex gap-3">
              <a
                href={whatsappLink("Hi, I just submitted an enquiry for Canada Visitor Visa. Please assist me further.")}
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
                Visit <span className="block text-red-200">Canada</span>
              </h1>
              <p className="text-lg text-red-100 leading-relaxed max-w-xl">
                Discover breathtaking landscapes, vibrant multicultural cities, and warm Canadian hospitality. 
                A Canada Visitor Visa lets you explore this incredible destination for tourism, 
                family visits, or short business trips.
              </p>
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl bg-red-900">
                ...
                <div className="absolute top-4 right-4 bg-white/95 backdrop-blur-sm rounded-xl px-4 py-3 shadow-lg">
                  ...
                  <div className="text-lg font-bold text-red-700">VISITOR VISA</div>
                </div>
              </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-600 leading-relaxed">
                Canada is one of the most beautiful countries in the world, known for its stunning 
                natural landscapes, vibrant cities, and welcoming people. From the Rocky Mountains to 
                Niagara Falls, Canada offers unforgettable experiences for every traveler.
              </p>
              <p className="text-gray-600 leading-relaxed">
                A Canada Visitor Visa allows you to explore this incredible country for tourism, visit family and friends, 
                or attend short-term business events. With IIL&apos;s expert visa consultants, your journey becomes 
                seamless and stress-free. We help you understand the requirements and prepare your application correctly.
              </p>
              <p className="text-gray-600 leading-relaxed">
                Whether you want to see the Northern Lights, explore Toronto&apos;s skyline, or reunite with loved ones, 
                Canada offers experiences that last a lifetime. Our team ensures your visa process is handled professionally 
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 max-w-xl mx-auto">
              Key reasons travellers choose Canada as their destination
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "From the Rocky Mountains to Niagara Falls and pristine lakes, Canada offers some of the world&apos;s most spectacular natural landscapes and outdoor experiences.",
              },
              {
                icon: Camera,
                title: "Iconic Landmarks",
                desc: "Visit world-famous sites like CN Tower, Banff National Park, Niagara Falls, and historic Quebec City — each offering unique memories.",
              },
              {
                icon: Users,
                title: "Family & Friends Visits",
                desc: "Reunite with loved ones living in Canada. A visitor visa makes it easy to spend quality time with family and friends across the country.",
              },
              {
                icon: Briefcase,
                title: "Short Business Trips",
                desc: "Attend conferences, meetings, or explore business opportunities in Canada&apos;s thriving economy with a valid visitor visa.",
              },
              {
                icon: Snowflake,
                title: "Four Distinct Seasons",
                desc: "Experience Canada&apos;s beautiful seasons — vibrant autumns, snowy winters, blooming springs, and sunny summers. Each season offers unique activities.",
              },
              {
                icon: Star,
                title: "World-Class Cities",
                desc: "Toronto, Vancouver, Montreal, and Calgary offer vibrant culture, excellent food scenes, shopping, and entertainment for every traveler.",
              },
              {
                icon: Heart,
                title: "Adventure & Activities",
                desc: "From skiing and hiking to whale watching and canoeing, Canada offers endless outdoor adventure activities for thrill-seekers and nature enthusiasts.",
              },
              {
                icon: Shield,
                title: "Safe & Welcoming",
                desc: "Canada is known for being one of the safest and most welcoming countries in the world, with excellent infrastructure and healthcare for visitors.",
              },
              {
                icon: BookOpen,
                title: "Rich Culture & Heritage",
                desc: "Explore Indigenous Canadian culture, modern art galleries, museums, and a diverse multicultural society that celebrates its heritage.",
              },
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {[
              ...
              },
              {
                ...
                desc: "Practical guidance on travel planning, insurance, and tips for a hassle-free Canadian trip.",
              },
            ].map(({ icon: Icon, title, desc }, i) => (
              <div
                key={i}
          ...
          <div className="mt-12 bg-red-50 border border-red-100 rounded-2xl p-8 max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a
                href={whatsappLink("Hi, I want to know more about Canada Visitor Visa.")}
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
            <div className="grid lg:grid-cols-2">
              <div className="bg-red-800 p-8 lg:p-12 text-white">
                <h2 className="text-3xl font-bold mb-3">Apply for Canada<br/>Visitor Visa</h2>
                ...
                <div className="space-y-5">
                  ...
                  <a href={whatsappLink("Hi, I\'m interested in Canada Visitor Visa. Please share more information.")} target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 hover:translate-x-1 transition-transform">
                    <div className="w-11 h-11 bg-white/10 rounded-lg flex items-center justify-center shrink-0">
                ...
                <div className="mt-8 pt-6 border-t border-white/20">
                  <div className="flex items-center gap-3 mb-5">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-red-200">Guiding travellers on their visa journey</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
              ...
              <div className="p-8 lg:p-12">
                <form onSubmit={handleSubmit} noValidate className="space-y-5">
                  ...
                  <div>
                    ...
                    <textarea id="message" name="message" rows={3} autoComplete="off" placeholder="Tell us about your travel plans..." value={formData.message} onChange={handleInputChange} className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none transition-all resize-none text-gray-900 placeholder-gray-400" />
                  </div>
                  ...
                  <a href={whatsappLink("Hi, I\'m interested in Canada Visitor Visa. Please share more information.")} target="_blank" rel="noopener noreferrer" className="w-full bg-[#25D366] text-white py-4 rounded-lg font-semibold hover:bg-[#1ebe57] transition-colors flex items-center justify-center gap-2">
      ...
      <section className="relative bg-gradient-to-r from-red-900 via-red-800 to-rose-700 text-white py-16 overflow-hidden">
        <div className="container mx-auto px-4 relative z-10 text-center max-w-3xl mx-auto">
          <h2 className="text-3xl lg:text-4xl font-bold mb-4">
            Start Your Journey to <span className="text-red-200">Canada</span>
          </h2>
          <p className="text-lg text-red-100 mb-8">
            Let IIL guide you toward an unforgettable Canadian experience. Contact us today!
          </p>
          <div className="flex flex-wrap justify-center gap-4">
...
export default CanadaVisitorPage;