...
const SpainPage = () => {
  ...
  const handleSubmit = useCallback(
    async (e) => {
      ...
      try {
        ...
        if (response.ok) {
          setShowPopup(true);
          setFormData({ name: "", email: "", phone: "", country: "Spain", qualification: "", course: "", message: "" });
        } else {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* ── Floating WhatsApp ── */}
      <a
        href={whatsappLink("Hi, I'm interested in studying in Spain. Please share more information.")}
        target="_blank"
        ...
        >
          ...
          >
            ...
            <div className="flex gap-3">
              <a
                href={whatsappLink("Hi, I just submitted an enquiry for Spain Study Visa. Please assist me further.")}
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
                Study in{" "}
                <span className="block text-rose-200">Spain</span>
              </h1>
              <p className="text-lg text-red-100 leading-relaxed max-w-xl">
                Spain offers a unique combination of quality education, vibrant culture, and Mediterranean lifestyle. 
                With English-taught programs at renowned universities and Schengen access, Spain is an excellent 
                destination for Indian students seeking global education and unforgettable experiences.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-600 leading-relaxed">
                Spain is a beautiful country located in southwestern Europe, known for its rich history, vibrant culture, 
                and Mediterranean lifestyle. It is a member of the European Union and the Schengen Area, offering students 
                the opportunity to explore Europe while pursuing their education. From historic cities like Barcelona and 
                Madrid to stunning beaches and mountain ranges, Spain offers a diverse and enriching environment for 
                international students.
              </p>
              <p className="text-gray-600 leading-relaxed">
                Spanish universities offer a wide range of programs taught in English, making it accessible for 
                international students. The country is known for its strong academic traditions, particularly in 
                fields like business, arts, tourism, and technology. With a warm climate, friendly people, and 
                affordable living costs compared to other Western European countries, Spain has become an increasingly 
                popular destination for students from around the world.
              </p>
              <p className="text-gray-600 leading-relaxed">
                Studying in Spain also provides the opportunity to learn Spanish, one of the most widely spoken 
                languages globally, which can significantly enhance career prospects. The country's strategic 
                location between Europe and Africa, combined with its strong economic ties to Latin America, 
                makes it an ideal place for students interested in international business and cross-cultural 
                experiences.
              </p>
              ...
              <div className="grid grid-cols-2 gap-4 pt-2">
                {[
                  { val: "Madrid", lbl: "Capital City" },
                  { val: "Euro (€)", lbl: "Currency" },
                  { val: "Spanish & English", lbl: "Languages" },
                  { val: "Southwestern Europe", lbl: "Location" },
                ].map(({ val, lbl }, i) => (
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 max-w-xl mx-auto">
              Key reasons international students choose Spain for higher education
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "As an EU and Schengen member, Spain allows students to travel freely across Europe during their studies, opening doors to diverse cultural and professional experiences.",
              },
              {
                icon: Languages,
                title: "English-Taught Programs",
                desc: "Many Spanish universities offer programs taught entirely in English, making quality education accessible to international students without requiring Spanish fluency.",
              },
              {
                icon: Heart,
                title: "Vibrant Culture & Lifestyle",
                desc: "Spain is famous for its rich cultural heritage, warm climate, delicious cuisine, and lively festivals. Students enjoy a high quality of life in a welcoming environment.",
              },
              {
                icon: GraduationCap,
                title: "Quality Education",
                desc: "Spanish universities maintain high academic standards with internationally recognized degrees. The education system emphasizes practical learning and innovation.",
              },
              {
                icon: Landmark,
                title: "Rich Artistic Heritage",
                desc: "Home to legendary artists and architectural marvels, Spain offers an inspiring environment for creative minds and those interested in arts, design, and history.",
              },
              {
                icon: Wallet,
                title: "Affordable Living",
                desc: "Compared to other Western European countries, Spain offers relatively affordable tuition fees and living costs, making it a budget-friendly study destination.",
              },
              {
                icon: Shield,
                title: "Safe & Welcoming",
                desc: "Spain is known for being safe and hospitable to international students. Cities like Barcelona, Madrid, and Valencia have large, diverse student communities.",
              },
              {
                icon: TrendingUp,
                title: "Strategic Location",
                desc: "Located at the crossroads of Europe and Africa with strong ties to Latin America, Spain offers unique opportunities for students interested in international relations and business.",
              },
              {
                icon: BookOpen,
                title: "Diverse Course Options",
                desc: "From business and tourism to engineering and arts, Spanish universities offer a wide variety of programs catering to different academic interests and career goals.",
              },
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-12 bg-red-50 border border-red-100 rounded-2xl p-8 max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a
                href={whatsappLink("Hi, I want to know more about studying in Spain.")}
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
            <div className="grid lg:grid-cols-2">
              ...
              <div className="bg-red-700 p-8 lg:p-12 text-white">
                <h2 className="text-3xl font-bold mb-3">Apply for Spain Study Visa</h2>
      ...
      <section className="relative bg-gradient-to-r from-red-800 via-red-700 to-rose-900 text-white py-16 overflow-hidden">
        <div className="container mx-auto px-4 relative z-10 text-center max-w-3xl mx-auto">
          <h2 className="text-3xl lg:text-4xl font-bold mb-4">
            ...
            <span className="text-rose-200">Spain</span>
          </h2>
          <p className="text-lg text-red-100 mb-8">
            Let IIL guide you toward world-class Spanish education and career opportunities.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <button
              onClick={() => scrollToSection("enquiry")}
