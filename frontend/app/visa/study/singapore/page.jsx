...
const SingaporePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* ── Floating WhatsApp ── */}
      <a
        href={whatsappLink("Hi, I'm interested in studying in Singapore. Please share more information.")}
        target="_blank"
        ...
        >
          ...
          >
            ...
            <div className="flex gap-3">
              <a
                href={whatsappLink("Hi, I just submitted an enquiry for Singapore Study Visa. Please assist me further.")}
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
                Study in{" "}
                <span className="block text-rose-200">Singapore</span>
              </h1>
              <p className="text-lg text-red-100 leading-relaxed max-w-xl">
                Discover world-class education in Asia's leading global city. Singapore offers top-ranked universities, 
                a multicultural environment, and excellent career opportunities for international students seeking 
                quality education in a dynamic, innovative hub.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-600 leading-relaxed">
                Singapore is a vibrant city-state located at the heart of Southeast Asia, known for its world-class 
                education system, multicultural atmosphere, and thriving economy. It has emerged as one of the most 
                sought-after destinations for international students seeking quality education in a dynamic, innovative environment.
              </p>
              <p className="text-gray-600 leading-relaxed">
                The country is a global hub for finance, technology, and business, home to many multinational companies 
                and world-renowned universities. With its strategic location in Asia, Singapore provides easy access to 
                other Asian markets and cultures, making it an ideal place for students to build international networks 
                and gain global exposure.
              </p>
              <p className="text-gray-600 leading-relaxed">
                English is the primary language of instruction in Singapore, making it accessible for international students. 
                The country is known for its safety, cleanliness, and excellent infrastructure, offering a high standard of 
                living that supports both academic pursuits and personal development.
              </p>

              {/* Quick facts */}
              <div className="grid grid-cols-2 gap-4 pt-2">
                {[
                  { val: "Singapore City", lbl: "Capital City" },
                  { val: "Singapore Dollar", lbl: "Currency" },
                  { val: "English", lbl: "Primary Language" },
                  { val: "Tropical", lbl: "Climate" },
                ].map(({ val, lbl }, i) => (
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 max-w-xl mx-auto">
              Key reasons international students choose Singapore for higher education
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Singapore is home to world-renowned universities that consistently rank among the best globally. The education system emphasizes innovation, research, and practical skills that prepare students for real-world success.",
              },
              {
                icon: Languages,
                title: "English-Taught Programs",
                desc: "English is the primary language of instruction in Singapore, making it a popular and accessible study destination for international students from all over the world without language barriers.",
              },
              {
                icon: Users,
                title: "Multicultural Environment",
                desc: "Singapore is a multicultural society with diverse populations from across Asia and beyond. Students experience varied perspectives, build wider networks, and develop a global mindset.",
              },
              {
                icon: Shield,
                title: "Safe & Secure",
                desc: "Singapore is known for being one of the safest countries in the world, with low crime rates and a stable political environment. Students can focus on their studies with peace of mind.",
              },
              {
                icon: Briefcase,
                title: "Career Opportunities",
                desc: "As a global hub for finance, technology, and business, Singapore is home to many multinational companies. Students have access to excellent internships, networking, and career connections.",
              },
              {
                icon: Globe,
                title: "Global Connectivity",
                desc: "Singapore's strategic location in Asia provides easy access to other Asian countries and markets. Students can explore diverse cultures and expand their horizons during their studies.",
              },
              {
                icon: TrendingUp,
                title: "Innovation & Research",
                desc: "Singapore has a strong research and innovation ecosystem with world-class universities, research institutes, and technology parks. Students are encouraged to think creatively and pursue cutting-edge ideas.",
              },
              {
                icon: Heart,
                title: "High Standard of Living",
                desc: "Known for its excellent healthcare system, modern infrastructure, and quality of life. Students can live and learn comfortably in a clean, efficient, and well-organized environment.",
              },
              {
                icon: Sparkles,
                title: "International Exposure",
                desc: "A country with great technological advancements and innovation. Students get involved in new ideas and cultures of various nationalities, building a truly global perspective.",
              },
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-12 bg-red-50 border border-red-100 rounded-2xl p-8 max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a
                href={whatsappLink("Hi, I want to know more about studying in Singapore.")}
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
            <div className="grid lg:grid-cols-2">
              ...
              <div className="bg-red-700 p-8 lg:p-12 text-white">
                <h2 className="text-3xl font-bold mb-3">Apply for Singapore Study Visa</h2>
              ...
              <div className="p-8 lg:p-12">
                <form onSubmit={handleSubmit} noValidate className="space-y-5">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-red-700 text-white py-4 rounded-lg font-semibold hover:bg-red-800 active:bg-red-900 transition-colors flex items-center justify-center gap-2 text-lg shadow-md hover:shadow-lg disabled:opacity-70 disabled:cursor-not-allowed"
                  >
                    {loading ? (
                      <>
      ...
      <section className="relative bg-gradient-to-r from-red-800 via-red-700 to-rose-900 text-white py-16 overflow-hidden">
        <div className="container mx-auto px-4 relative z-10 text-center max-w-3xl mx-auto">
          <h2 className="text-3xl lg:text-4xl font-bold mb-4">
            ...
            <span className="text-rose-200">Singapore</span>
          </h2>
          <p className="text-lg text-red-100 mb-8">
            Let IIL guide you toward world-class Singaporean education and career opportunities.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <button
              onClick={() => scrollToSection("enquiry")}
