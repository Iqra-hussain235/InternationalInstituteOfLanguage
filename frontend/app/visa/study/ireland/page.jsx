...
import {
  ...
  Compass, FileText, Wallet, Landmark, BookOpen, Search,
  Lightbulb, Sun, Clock, Fingerprint, FileCheck, DollarSign
} from "lucide-react";
...
const IrelandPage = () => {
  ...
  const handleSubmit = useCallback(
    async (e) => {
      ...
      try {
        ...
        if (data.success) {
          setShowPopup(true);
          setFormData({ name: "", email: "", phone: "", country: "Ireland", qualification: "", course: "", message: "" });
        } else {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* ── Floating WhatsApp ── */}
      <a
        href={whatsappLink("Hi, I'm interested in studying in Ireland. Please share more information.")}
        target="_blank"
        ...
        >
          ...
          >
            ...
            <div className="flex gap-3">
              <a
                href={whatsappLink("Hi, I just submitted an enquiry for Ireland Study Visa. Please assist me further.")}
                target="_blank"
                rel="noopener noreferrer"
      ...
      {/* ══════════════════════════════════════════
          HERO
      ══════════════════════════════════════════ */}
      <section className="relative bg-gradient-to-br from-green-800 via-green-700 to-orange-700 text-white overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
                Study in{" "}
                <span className="block text-orange-300">Ireland</span>
              </h1>
              <p className="text-lg text-green-100 leading-relaxed max-w-xl">
                Perched on the northwest tip of Europe, Ireland is where even time getting lost will be worthwhile. 
                With ancient myths and legends to uncover, amazing landscapes to explore, and locals who will be 
                more than happy to reveal our hidden gems. After completing your study in Ireland, it is guaranteed 
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl bg-green-900">
                {!imgError.hero ? (
                  ...
                  <div className="w-full h-[400px] bg-gradient-to-br from-green-800 to-orange-700 flex items-center justify-center">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-600 leading-relaxed">
                Ireland has a magical lure for many expatriates, all thanks to a strong and thriving economy and some 
                of the world's most beautiful scenic views. Not many places outside of the tropics are as green as Ireland. 
                It features rolling hills and meadows with fuchsias growing all along the roadsides. It also speaks of miles 
                of unspoiled and rugged coastline.
              </p>
              <p className="text-gray-600 leading-relaxed">
                The maritime climate of Ireland is comparatively milder than most of Europe. Temperatures range from 16 to 
                75 degrees Fahrenheit, with mean temperatures of 40 in winter and 60 in summer. Along with the number of rainy 
                days endured by Ireland each year, it also has much on its side, from its international, social, and economic 
                standing to its views on equal rights and freedom of speech.
              </p>

              {/* Quick facts */}
              <div className="grid grid-cols-2 gap-4 pt-2">
                {[
                  { val: "Dublin", lbl: "Capital City" },
                  { val: "Euro (€)", lbl: "Currency" },
                  { val: "English", lbl: "Language" },
                  { val: "5.1M", lbl: "Population" },
                ].map(({ val, lbl }, i) => (
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 max-w-xl mx-auto">
              Key reasons international students choose Ireland for higher education
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                icon: GraduationCap,
                title: "World's Best Education",
                desc: "Ireland has one of the world's best education systems with the highest international quality standards.",
              },
              {
                icon: TrendingUp,
                title: "Economic Growth",
                desc: "The towering standards of the Irish education system drive Ireland's rapidly increasing economic growth rate.",
              },
              {
                icon: Globe,
                title: "Global Recognition",
                desc: "The higher education institutions in Ireland are primarily recognized worldwide for excellence in all disciplines.",
              },
              {
                icon: Lightbulb,
                title: "Research Excellence",
                desc: "Ireland is regarded as an international location for high-quality scientific research.",
              },
              {
                icon: Heart,
                title: "Friendly People",
                desc: "One of the most inspiring reasons to study in Ireland is the Irish people, distinguished for their friendliness and warm hospitality.",
              },
              {
                icon: Users,
                title: "Young & Vibrant",
                desc: "Ireland is recognized as the most exciting place to live as it features a young, vibrant population, with 40% under 25.",
              },
              {
                icon: Sun,
                title: "Natural Beauty",
                desc: "A land of immense natural beauty, providing an admirable natural habitat for flourishing flora and fauna.",
              },
              {
                icon: Landmark,
                title: "Rich Culture",
                desc: "Ireland has a rich cultural heritage, having its distinctive language (Gaelic), music, culture, and sports.",
              },
              {
                icon: Shield,
                title: "Safe & Peaceful",
                desc: "It is one of the world's most safe and peaceful countries, for students in particular.",
              },
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-12 bg-green-50 border border-green-100 rounded-2xl p-8 max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a
                href={whatsappLink("Hi, I want to know more about studying in Ireland.")}
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
            <div className="grid lg:grid-cols-2">
              ...
              <div className="bg-green-800 p-8 lg:p-12 text-white">
                <h2 className="text-3xl font-bold mb-3">Apply for Ireland Study Visa</h2>
                ...
                <form onSubmit={handleSubmit} noValidate className="space-y-5">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="natural-science">Natural Sciences</option>
      ...
      {/* ══════════════════════════════════════════
          BOTTOM BANNER
      ══════════════════════════════════════════ */}
      <section className="relative bg-gradient-to-r from-green-800 via-green-700 to-orange-700 text-white py-16 overflow-hidden">
        <div className="container mx-auto px-4 relative z-10 text-center max-w-3xl mx-auto">
          <h2 className="text-3xl lg:text-4xl font-bold mb-4">
            Start Your Journey to{" "}
            <span className="text-orange-300">Ireland</span>
          </h2>
          <p className="text-lg text-green-100 mb-8">
            Let IIL guide you toward world-class Irish education and career opportunities.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <button
              onClick={() => scrollToSection("enquiry")}
