...
const USAPage = () => {
  ...
  const handleSubmit = useCallback(
    async (e) => {
      ...
      try {
        ...
        if (response.ok) {
          setShowPopup(true);
          setFormData({ name: "", email: "", phone: "", country: "United States", qualification: "", course: "", message: "" });
        } else {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* ── Floating WhatsApp ── */}
      <a
        href={whatsappLink("Hi, I'm interested in studying in the United States. Please share more information.")}
        target="_blank"
        ...
        >
          ...
          >
            ...
            <div className="flex gap-3">
              <a
                href={whatsappLink("Hi, I just submitted an enquiry for USA Study Visa. Please assist me further.")}
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
                Study in{" "}
                <span className="block text-blue-200">United States</span>
              </h1>
              <p className="text-lg text-blue-100 leading-relaxed max-w-xl">
                The United States offers one of the most diverse and dynamic education systems in the world. 
                With thousands of universities and colleges offering a wide range of programs, the USA provides 
                excellent academic and career opportunities for international students seeking world-class education.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-600 leading-relaxed">
                The United States is home to one of the largest and most diverse higher education systems 
                in the world. With thousands of universities and colleges spread across the country, students 
                can choose from a vast array of academic programs, research opportunities, and campus experiences 
                that cater to virtually every interest and career goal.
              </p>
              <p className="text-gray-600 leading-relaxed">
                American universities are known for their emphasis on practical learning, innovation, and 
                research. The education system encourages critical thinking, creativity, and hands-on experience, 
                preparing students for success in the global job market. Many institutions have strong ties 
                with industry leaders, offering students valuable internship and networking opportunities.
              </p>
              <p className="text-gray-600 leading-relaxed">
                The USA is a melting pot of cultures, welcoming students from every corner of the globe. 
                From bustling cities like New York and Los Angeles to serene college towns, the country 
                offers a wide variety of environments for students to live, learn, and grow. Studying in 
                the USA provides not just academic knowledge but also cultural enrichment and lifelong friendships.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 max-w-xl mx-auto">
              Key reasons international students choose the USA for higher education
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "US universities are known for their high academic standards, cutting-edge research facilities, and innovative teaching methods that prepare students for global careers.",
              },
              {
                icon: BookOpen,
                title: "Diverse Programs",
                desc: "With thousands of institutions offering programs in virtually every field, students can find courses that perfectly match their academic interests and career aspirations.",
              },
              {
                icon: Briefcase,
                title: "Practical Learning",
                desc: "The US education system emphasizes hands-on experience, internships, and real-world projects that help students develop skills employers value.",
              },
              {
                icon: Wallet,
                title: "Scholarship Opportunities",
                desc: "Many US universities offer financial aid and scholarships to international students based on merit, need, or specific talents, making education more accessible.",
              },
              {
                icon: Shield,
                title: "Safe Environment",
                desc: "US campuses prioritize student safety with dedicated security services, health centers, and support systems designed to help international students thrive.",
              },
              {
                icon: Globe,
                title: "Globally Recognized",
                desc: "A degree from a US institution is respected worldwide and can open doors to career opportunities across the globe in virtually every industry.",
              },
              {
                icon: Users,
                title: "Cultural Diversity",
                desc: "The USA welcomes students from all backgrounds, creating a rich multicultural environment where you can learn from peers representing every continent.",
              },
              {
                icon: Heart,
                title: "Student Support",
                desc: "Universities provide comprehensive support services including academic advising, career counseling, health services, and international student offices.",
              },
              {
                icon: TrendingUp,
                title: "Career Opportunities",
                desc: "Studying in the USA provides access to internships, networking events, and job fairs with leading companies, enhancing your professional prospects.",
              },
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-12 bg-blue-50 border border-blue-100 rounded-2xl p-8 max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a
                href={whatsappLink("Hi, I want to know more about studying in the United States.")}
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
            <div className="grid lg:grid-cols-2">
              ...
              <div className="bg-blue-800 p-8 lg:p-12 text-white">
                <h2 className="text-3xl font-bold mb-3">Apply for USA Study Visa</h2>
      ...
      <section className="relative bg-gradient-to-r from-blue-900 via-blue-800 to-blue-700 text-white py-16 overflow-hidden">
        <div className="container mx-auto px-4 relative z-10 text-center max-w-3xl mx-auto">
          ...
          <p className="text-lg text-blue-100 mb-8">
            Let IIL guide you toward world-class US education and career opportunities.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <button
              onClick={() => scrollToSection("enquiry")}
              className="bg-white text-blue-900 px-8 py-4 rounded-xl font-semibold hover:bg-blue-50 hover:scale-105 transition-all duration-300 flex items-center gap-2"
            >
