...
const AustraliaPage = () => {
  ...
  const handleSubmit = useCallback(
    async (e) => {
      ...
      try {
        ...
        if (data.success) {
          setShowPopup(true);
          setFormData({ name: "", email: "", phone: "", country: "Australia", qualification: "", course: "", message: "" });
        } else {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* ── Floating WhatsApp ── */}
      <a
        href={whatsappLink("Hi, I'm interested in studying in Australia. Please share more information.")}
        target="_blank"
        ...
        >
          ...
          >
            ...
            <div className="flex gap-3">
              <a
                href={whatsappLink("Hi, I just submitted an enquiry for Australia Study Visa. Please assist me further.")}
                target="_blank"
                rel="noopener noreferrer"
              ...
              <button
                onClick={closePopup}
                className="flex-1 bg-green-800 text-white px-4 py-3 rounded-lg hover:bg-green-900 transition-colors font-semibold"
              >
                Close
              </button>
            </div>
      ...
      {/* ══════════════════════════════════════════
          HERO
      ══════════════════════════════════════════ */}
      <section className="relative bg-gradient-to-br from-green-800 via-green-700 to-emerald-900 text-white overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
                Study in{" "}
                <span className="block text-emerald-200">Australia</span>
              </h1>
              <p className="text-lg text-green-100 leading-relaxed max-w-xl">
                World-class education, stunning landscapes, and vibrant multicultural cities.
                Australia welcomes international students with strong work and post-study opportunities.
              </p>
              ...
              <div className="flex flex-wrap items-center gap-6 pt-2">
                {[
                  ...
                  { icon: GraduationCap, bold: "CRICOS", sub: "Registered Institutions" },
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                welcoming learners from across the world to its leading universities, colleges, and
                vocational institutes. Its natural beauty, pleasant climate, and modern infrastructure
                make it a sought-after place to live and study.
              </p>
              <p className="text-gray-600 leading-relaxed">
                Known for its stunning coastlines, unique wildlife, and friendly multicultural cities,
                Australia offers students space, safety, and a relaxed lifestyle alongside
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 max-w-xl mx-auto">
              Key reasons international students choose Australia for higher education
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                icon: Shield,
                title: "Student Protections (ESOS)",
                desc: "The Education Services for Overseas Students Act ensures quality education and legal protection for all international students.",
              },
              {
                icon: Sparkles,
                title: "World-Class Research",
                desc: "Australian universities are known for research-oriented teaching, innovation, and technology-based programs.",
              },
              {
                icon: Briefcase,
                title: "Work While You Study",
                desc: "Eligible student visa holders may work part-time during term and full-time during breaks, subject to current visa conditions.",
              },
              {
                icon: Plane,
                title: "Post-Study Work Pathways",
                desc: "Australia offers post-study work visa options for eligible graduates — contact our team for current eligibility details.",
              },
              {
                icon: Award,
                title: "Globally Recognised Degrees",
                desc: "Australian qualifications are respected worldwide, with several universities consistently featuring in global QS rankings.",
              },
              {
                icon: Heart,
                title: "Quality of Life",
                desc: "Cities like Melbourne, Sydney, and Brisbane are consistently ranked among the world's most livable cities.",
              },
              {
                icon: Users,
                title: "Multicultural Society",
                desc: "A safe, welcoming, and diverse environment for students from every background and culture.",
              },
              {
                icon: Wallet,
                title: "Scholarship Opportunities",
                desc: "Various scholarships and funding options may be available to eligible international students. Enquire with our team.",
              },
              {
                icon: TrendingUp,
                title: "Strong Job Market",
                desc: "Opportunities across healthcare, engineering, IT, and business sectors for qualified graduates.",
              },
      ...
      <section className="py-16 lg:py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 max-w-xl mx-auto">
              Our team guides you at every step — from choosing the right course to visa preparation
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {[
              ...
              },
              {
                ...
                desc: "Help organising and reviewing the documents your admission and visa application will need.",
              },
              {
                icon: Shield,
                title: "Visa File Preparation",
                desc: "Guidance on preparing a genuine, complete visa application as per current Australian rules.",
              },
              {
                icon: Heart,
          ...
          <div className="mt-12 bg-green-50 border border-green-100 rounded-2xl p-8 max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <button
                onClick={() => scrollToSection("enquiry")}
                className="bg-green-800 text-white px-7 py-3 rounded-xl font-semibold hover:bg-green-900 hover:scale-105 transition-all duration-300 flex items-center gap-2"
              >
                Send an Enquiry <ArrowRight className="w-4 h-4" />
              </button>
              <a
                href={whatsappLink("Hi, I want to know more about studying in Australia.")}
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
            <div className="grid lg:grid-cols-2">
              ...
              <div className="bg-green-800 p-8 lg:p-12 text-white">
                <h2 className="text-3xl font-bold mb-3">Apply for Australia Study Visa</h2>
      ...
      {/* ══════════════════════════════════════════
          BOTTOM BANNER
      ══════════════════════════════════════════ */}
      <section className="relative bg-gradient-to-r from-green-800 to-emerald-900 text-white py-16 overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <Image src="/australia-image.png" alt="Australia" fill className="object-cover" />
        </div>
        <div className="container mx-auto px-4 relative z-10 text-center max-w-3xl mx-auto">
          <h2 className="text-3xl lg:text-4xl font-bold mb-4">
            Start Your Journey to{" "}
            <span className="text-emerald-200">Australia</span>
          </h2>
          <p className="text-lg text-green-100 mb-8">
            Let IIL guide you toward world-class Australian education. Your future begins here.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <button
              onClick={() => scrollToSection("enquiry")}
