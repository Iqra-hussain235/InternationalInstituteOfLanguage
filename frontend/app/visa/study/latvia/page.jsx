...
const LatviaPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* ── Floating WhatsApp ── */}
      <a
        href={whatsappLink("Hi, I'm interested in studying in Latvia. Please share more information.")}
        target="_blank"
        ...
        >
          ...
          >
            ...
            <div className="flex gap-3">
              <a
                href={whatsappLink("Hi, I just submitted an enquiry for Latvia Study Visa. Please assist me further.")}
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
                Study in{" "}
                <span className="block text-rose-200">Latvia</span>
              </h1>
              <p className="text-lg text-red-100 leading-relaxed max-w-xl">
                Discover affordable European education in the land that sings. Latvia offers English-taught programs, 
                Schengen access, and a vibrant multicultural environment for international students seeking quality education.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-600 leading-relaxed">
                Latvia is known as the land that sings, a symphony of sounds, experiences, and sights. Located in the Baltic region of Northern Europe, 
                Latvia is the second greenest country in the world according to Yale and Columbia universities EPI index research.
              </p>
              <p className="text-gray-600 leading-relaxed">
                ...
                degrees are recognized across the EU and worldwide. The capital Riga is famous for its Art Nouveau architecture and UNESCO World Heritage Old Town.
              </p>
              <p className="text-gray-600 leading-relaxed">
                Latvia has one of the fastest-growing economies in the EU and is becoming a hub for technology, fintech, and logistics. 
                English is widely spoken in academic settings and business environments, making it easy for international students to adapt.
              </p>

              {/* Quick facts */}
              <div className="grid grid-cols-2 gap-4 pt-2">
                {[
                  { val: "Riga", lbl: "Capital City" },
                  { val: "EUR", lbl: "Currency" },
                  { val: "Latvian & English", lbl: "Languages" },
                  { val: "1.9M", lbl: "Population" },
                ].map(({ val, lbl }, i) => (
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 max-w-xl mx-auto">
              Key reasons international students choose Latvia for higher education
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Latvia offers among the most affordable tuition fees in the EU. Scholarship funding is provided through universities and government programs.",
              },
              {
                icon: Globe,
                title: "English-Taught Programs",
                desc: "Over 100 study programs taught entirely in English. Wide range from engineering and medicine to business and IT. No language barrier.",
              },
              {
                icon: Shield,
                title: "Schengen EU Access",
                desc: "Study in Latvia and travel freely across Schengen countries. Explore Europe without additional visa requirements during your studies.",
              },
              {
                icon: Users,
                title: "Multicultural Environment",
                desc: "Students from over 60 countries study in Latvia. Welcoming international community with active student organizations and events.",
              },
              {
                icon: Award,
              ...
              },
              {
                ...
                desc: "Latvia is a rising fintech and IT hub. Major companies and startups have offices here. Good career prospects in technology and business services.",
              },
              {
                icon: Sparkles,
                title: "Natural Beauty",
                desc: "The second greenest country in the world with stunning forests, lakes, and coastline. Four distinct seasons offer diverse experiences year-round.",
              },
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-12 bg-red-50 border border-red-100 rounded-2xl p-8 max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a
                href={whatsappLink("Hi, I want to know more about studying in Latvia.")}
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
            <div className="grid lg:grid-cols-2">
              ...
              <div className="bg-red-700 p-8 lg:p-12 text-white">
                <h2 className="text-3xl font-bold mb-3">Apply for Latvia Study Visa</h2>
      ...
      <section className="relative bg-gradient-to-r from-red-800 via-red-700 to-rose-900 text-white py-16 overflow-hidden">
        <div className="container mx-auto px-4 relative z-10 text-center max-w-3xl mx-auto">
          <h2 className="text-3xl lg:text-4xl font-bold mb-4">
            ...
            <span className="text-rose-200">Latvia</span>
          </h2>
          <p className="text-lg text-red-100 mb-8">
            Let IIL guide you toward world-class Latvian education and career opportunities.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <button
              onClick={() => scrollToSection("enquiry")}
