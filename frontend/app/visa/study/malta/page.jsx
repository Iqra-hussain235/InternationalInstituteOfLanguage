...
const MaltaPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* ── Floating WhatsApp ── */}
      <a
        href={whatsappLink("Hi, I'm interested in studying in Malta. Please share more information.")}
        target="_blank"
        ...
        >
          ...
          >
            ...
            <div className="flex gap-3">
              <a
                href={whatsappLink("Hi, I just submitted an enquiry for Malta Study Visa. Please assist me further.")}
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
                Study in{" "}
                <span className="block text-rose-200">Malta</span>
              </h1>
              <p className="text-lg text-red-100 leading-relaxed max-w-xl">
                Discover high-quality education in a beautiful Mediterranean setting. Malta offers English-taught programs, 
                EU membership benefits, and a vibrant multicultural environment for international students seeking world-class education.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-600 leading-relaxed">
                Malta, officially the Republic of Malta, is a beautiful Mediterranean island nation located in Southern Europe. 
                Throughout its rich history, Malta's strategic location has made it a crossroads of civilizations, resulting in a unique 
                blend of cultures and traditions that continue to shape its vibrant society today.
              </p>
              <p className="text-gray-600 leading-relaxed">
                The country is a member of the European Union, the Schengen Area, and the eurozone. With a well-developed education 
                system that follows international standards, degrees earned in Malta are recognized across the EU and worldwide. 
                The capital Valletta is a UNESCO World Heritage city known for its stunning baroque architecture and historic significance.
              </p>
              <p className="text-gray-600 leading-relaxed">
                English is widely spoken in Malta, making it an ideal destination for international students. The country's warm climate, 
                beautiful beaches, and safe environment create a perfect setting for both academic pursuits and personal growth.
              </p>

              {/* Quick facts */}
              <div className="grid grid-cols-2 gap-4 pt-2">
                {[
                  { val: "Valletta", lbl: "Capital City" },
                  { val: "Euro (€)", lbl: "Currency" },
                  { val: "English & Maltese", lbl: "Languages" },
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 max-w-xl mx-auto">
              Key reasons international students choose Malta for higher education
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                icon: Languages,
                title: "English Mode of Education",
                desc: "English is widely spoken in Malta. Education is provided in English, making it a perfect study-abroad destination for international students without language barriers.",
              },
              {
                icon: Globe,
                title: "Part of European Union",
                desc: "As an EU member, Malta offers economic stability, continuous global growth, and freedom to travel across other European countries during your studies.",
              },
              {
                icon: GraduationCap,
                title: "High Standard of Education",
                desc: "High quality of teaching makes Malta favorable for international studies. Students gain practical knowledge along with theoretical learning in a supportive environment.",
              },
              {
                icon: Wallet,
                title: "Affordable Living",
                desc: "Malta offers affordable living and studying compared to many other European nations. Students can comfortably manage basic amenities while pursuing their education.",
              },
              {
                icon: Sun,
                title: "Perfect Mediterranean Climate",
                desc: "The climate in Malta is warm and healthy year-round. Beautiful sunshine, mild winters, and stunning beaches create an ideal environment for study and leisure.",
              },
              {
                icon: Shield,
                title: "Safe & Friendly Environment",
                desc: "Malta is known for its peaceful atmosphere and friendly locals. The welcoming environment encourages students to focus fully on their academic and personal development.",
              },
              {
                icon: Heart,
                title: "Rich Cultural Heritage",
                desc: "With a history spanning thousands of years, Malta offers incredible cultural experiences. From ancient temples to medieval cities, there is always something to explore.",
              },
              {
                icon: TrendingUp,
                title: "Growing Economy",
                desc: "Malta has a thriving economy with strong sectors in tourism, finance, gaming, and technology. This creates opportunities for students to gain practical experience and build careers.",
              },
              {
                icon: Sparkles,
                title: "Schengen Travel Access",
                desc: "As a Schengen member, students can travel freely across European countries, opening doors to explore diverse cultures and expand their horizons during their studies.",
              },
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-12 bg-red-50 border border-red-100 rounded-2xl p-8 max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a
                href={whatsappLink("Hi, I want to know more about studying in Malta.")}
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
            <div className="grid lg:grid-cols-2">
              ...
              <div className="bg-red-700 p-8 lg:p-12 text-white">
                <h2 className="text-3xl font-bold mb-3">Apply for Malta Study Visa</h2>
      ...
      <section className="relative bg-gradient-to-r from-red-800 via-red-700 to-rose-900 text-white py-16 overflow-hidden">
        <div className="container mx-auto px-4 relative z-10 text-center max-w-3xl mx-auto">
          <h2 className="text-3xl lg:text-4xl font-bold mb-4">
            ...
            <span className="text-rose-200">Malta</span>
          </h2>
          <p className="text-lg text-red-100 mb-8">
            Let IIL guide you toward world-class Maltese education and career opportunities.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <button
              onClick={() => scrollToSection("enquiry")}
