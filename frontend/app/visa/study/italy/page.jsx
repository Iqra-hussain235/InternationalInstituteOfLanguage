...
import {
  ...
  Compass, FileText, Wallet, Landmark, Sun, Languages
} from "lucide-react";
...
const ItalyPage = () => {
  ...
  const handleSubmit = useCallback(
    async (e) => {
      ...
      try {
        ...
        if (data.success) {
          setShowPopup(true);
          setFormData({ name: "", email: "", phone: "", country: "Italy", qualification: "", course: "", message: "" });
        } else {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* ── Floating WhatsApp ── */}
      <a
        href={whatsappLink("Hi, I'm interested in studying in Italy. Please share more information.")}
        target="_blank"
        ...
        >
          ...
          >
            ...
            <div className="flex gap-3">
              <a
                href={whatsappLink("Hi, I just submitted an enquiry for Italy Study Visa. Please assist me further.")}
                target="_blank"
                rel="noopener noreferrer"
              ...
              <button
                onClick={closePopup}
                className="flex-1 bg-green-700 text-white px-4 py-3 rounded-lg hover:bg-green-800 transition-colors font-semibold"
              >
                Close
              </button>
            </div>
      ...
      {/* ══════════════════════════════════════════
          HERO
      ══════════════════════════════════════════ */}
      <section className="relative bg-gradient-to-br from-green-800 via-green-700 to-red-700 text-white overflow-hidden">
        <div className="absolute -top-24 -right-24 w-96 h-96 bg-red-400/10 rounded-full blur-3xl pointer-events-none" />
        <div className="absolute -bottom-24 -left-24 w-96 h-96 bg-green-300/10 rounded-full blur-3xl pointer-events-none" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
                Study in{" "}
                <span className="block text-red-200">Italy</span>
              </h1>
              <p className="text-lg text-green-100 leading-relaxed max-w-xl">
                Italy is a beautiful country with various cities, landscapes, and historical landmarks to explore. 
                It is one of the popular study locations in Europe to expand your perspective with quality education.
              </p>
              <div className="flex flex-wrap gap-4">
                <button
                  onClick={() => scrollToSection("enquiry")}
                  className="bg-white text-green-800 px-8 py-4 rounded-xl font-semibold hover:bg-green-50 hover:scale-105 transition-all duration-300 flex items-center gap-2 shadow-lg"
                >
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl bg-green-900">
                {!imgError.hero ? (
                  ...
                  <div className="w-full h-[400px] bg-gradient-to-br from-green-800 to-red-700 flex items-center justify-center">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-600 leading-relaxed">
                Italy is a country located in Southern Europe, bordering Switzerland and Austria to the north, France to the 
                west, Slovenia to the east, and the Mediterranean Sea to the south. It is one of the popular study locations 
                in Europe to expand your perspective.
              </p>
              <p className="text-gray-600 leading-relaxed">
                Italy's economy is based on manufacturing, agriculture, and tourism. Some of Italy's top industries include 
                fashion, wine production, and luxury automobiles. Italy's education system provides a wide selection of courses 
                and disciplines.
              </p>
              ...
              <div className="grid grid-cols-2 gap-4 pt-2">
                {[
                  { val: "Rome", lbl: "Capital City" },
                  { val: "Euro (€)", lbl: "Currency" },
                  { val: "Italian / English", lbl: "Languages" },
                  { val: "59.1M", lbl: "Population" },
                ].map(({ val, lbl }, i) => (
                  <div key={i} className="bg-gray-50 p-4 rounded-xl hover:bg-green-50 transition-colors">
                    <p className="font-bold text-xl text-green-700">{val}</p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 max-w-xl mx-auto">
              Key reasons international students choose Italy for higher education
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Italy is home to rich cultural collections and a great place to study art, history, architecture, and culture. Incredible sites like Vatican City, the Colosseum, and the Leaning Tower of Pisa.",
              },
              {
                icon: GraduationCap,
                title: "High-Quality Education",
                desc: "Italy is known for its high-quality education system, with many prestigious universities offering courses in various fields. University of Bologna is one of the oldest universities.",
              },
              {
                icon: Wallet,
                title: "Affordable Tuition Fees",
                desc: "Italy offers relatively low tuition fees compared to other countries. Average tuition is approx. €850 to €1,000 EUR/year. Scholarship funding is provided through universities.",
              },
              {
                icon: Sun,
                title: "Stunning Landscapes",
                desc: "From the rolling hills of Tuscany to the coastlines of the Amalfi Coast. Enjoy diverse beaches and snow-capped mountains. Famous for world-renowned paintings and sculptures.",
              },
              {
                icon: Heart,
                title: "Delicious Food",
                desc: "Italian cuisine is famous worldwide for its delicious flavors. In Italy, food is a form of art and life. With incredible diversity, Italy's food is considered the tastiest.",
              },
              {
                icon: Languages,
                title: "Language Immersion",
                desc: "Studying in Italy allows you to learn or improve your Italian language skills while immersed in the local culture. Learning a new language broadens career opportunities.",
              },
              {
                icon: Globe,
                title: "Convenient Location",
                desc: "Italy is in the heart of Europe, making it easy to travel to other European countries. Students who choose fashion, art, and architecture never regret their decision.",
              },
              {
                icon: Sparkles,
                title: "Birthplace of Renaissance",
                desc: "Italy is a country full of symbolic features, architectural wonders, and the birthplace of Renaissance art. Explore the world's most prominent museums.",
              },
              {
                icon: TrendingUp,
                title: "Cheapest EU Destination",
                desc: "Italy is the cheapest destination to study abroad in Europe. The estimated cost of living is relatively affordable compared to other EU countries.",
              },
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {[
              ...
              <div
                key={i}
                className="text-center p-6 rounded-2xl border border-gray-100 hover:border-green-200 hover:bg-green-50/40 hover:-translate-y-1 transition-all duration-300"
              >
          ...
          {/* CTA nudge */}
          <div className="mt-12 bg-green-50 border border-green-100 rounded-2xl p-8 max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <button
                onClick={() => scrollToSection("enquiry")}
                className="bg-green-700 text-white px-7 py-3 rounded-xl font-semibold hover:bg-green-800 hover:scale-105 transition-all duration-300 flex items-center gap-2"
              >
                Send an Enquiry <ArrowRight className="w-4 h-4" />
              </button>
              <a
                href={whatsappLink("Hi, I want to know more about studying in Italy.")}
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
            <div className="grid lg:grid-cols-2">
              ...
              {/* Left – contact info */}
              <div className="bg-green-800 p-8 lg:p-12 text-white">
                <h2 className="text-3xl font-bold mb-3">Apply for Italy Study Visa</h2>
                ...
                <div className="space-y-5">
                  ...
                  >
                    ...
                    <div>
                      <p className="text-xs text-green-200">WhatsApp Us</p>
                      <p className="font-semibold text-sm">{PHONE_NUMBER}</p>
                    </div>
                  </a>
                  ...
                  >
                    ...
                    <div>
                      <p className="text-xs text-green-200">Email Us</p>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-xs text-green-200">Visit Us</p>
                ...
                <div className="mt-8 pt-6 border-t border-white/20">
                  <div className="flex items-center gap-3 mb-5">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-green-200">Guiding students on their study abroad journey</p>
                    </div>
                  </div>
                ...
                <form onSubmit={handleSubmit} noValidate className="space-y-5">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none transition-all text-gray-900 placeholder-gray-400"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none transition-all text-gray-900"
                    >
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="arts">Arts / Design / Fashion</option>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none transition-all resize-none text-gray-900 placeholder-gray-400"
                    />
                  </div>
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-green-800 text-white py-4 rounded-lg font-semibold hover:bg-green-900 active:bg-green-950 transition-colors flex items-center justify-center gap-2 text-lg shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                  >
      ...
      {/* ══════════════════════════════════════════
          BOTTOM BANNER
      ══════════════════════════════════════════ */}
      <section className="relative bg-gradient-to-r from-green-800 via-green-700 to-red-700 text-white py-16 overflow-hidden">
        <div className="container mx-auto px-4 relative z-10 text-center max-w-3xl mx-auto">
          <h2 className="text-3xl lg:text-4xl font-bold mb-4">
            Start Your Journey to{" "}
            <span className="text-red-200">Italy</span>
          </h2>
          <p className="text-lg text-green-100 mb-8">
            Let IIL guide you toward world-class Italian education and career opportunities.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <button
              onClick={() => scrollToSection("enquiry")}
              className="bg-white text-green-800 px-8 py-4 rounded-xl font-semibold hover:bg-green-50 hover:scale-105 transition-all duration-300 flex items-center gap-2"
            >
