...
const GermanyPage = () => {
  ...
  const handleSubmit = useCallback(
    async (e) => {
      ...
      try {
        ...
        if (data.success) {
          setShowPopup(true);
          setFormData({ name: "", email: "", phone: "", country: "Germany", qualification: "", course: "", message: "" });
        } else {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* ── Floating WhatsApp ── */}
      <a
        href={whatsappLink("Hi, I'm interested in studying in Germany. Please share more information.")}
        target="_blank"
        ...
        >
          ...
          >
            ...
            <div className="flex gap-3">
              <a
                href={whatsappLink("Hi, I just submitted an enquiry for Germany Study Visa. Please assist me further.")}
                target="_blank"
                rel="noopener noreferrer"
      ...
      {/* ══════════════════════════════════════════
          HERO
      ══════════════════════════════════════════ */}
      <section className="relative bg-gradient-to-br from-gray-900 via-red-900 to-rose-900 text-white overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
                Study in{" "}
                <span className="block text-yellow-300">Germany</span>
              </h1>
              <p className="text-lg text-red-100 leading-relaxed max-w-xl">
                World-renowned universities, innovative research opportunities, and a welcoming multicultural
                environment. Germany is one of the top destinations for international students seeking
                quality education and exceptional career growth.
              </p>
              <div className="flex flex-wrap gap-4">
                <button
                  onClick={() => scrollToSection("enquiry")}
                  className="bg-white text-gray-900 px-8 py-4 rounded-xl font-semibold hover:bg-red-50 hover:scale-105 transition-all duration-300 flex items-center gap-2 shadow-lg"
                >
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl bg-red-900">
                {!imgError.hero ? (
                  ...
                  <div className="w-full h-[400px] bg-gradient-to-br from-gray-900 to-red-900 flex items-center justify-center">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-600 leading-relaxed">
                Germany is one of the most sought-after study destinations in the world, known
                for its high-quality education system, innovative research opportunities, and inclusive
                society. Students from across the globe choose Germany for its globally
                recognised degrees and welcoming environment.
              </p>
              <p className="text-gray-600 leading-relaxed">
                With strong engineering and research traditions, modern cities, and a robust economy, Germany
              ...
              <div className="grid grid-cols-2 gap-4 pt-2">
                {[
                  ...
                  { val: "German & English", lbl: "Languages" },
                  { val: "83.3M", lbl: "Population" },
                ].map(({ val, lbl }, i) => (
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 max-w-xl mx-auto">
              Key reasons international students choose Germany for higher education
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Germany is home to globally recognised universities and colleges offering a wide range of programs across every field of study.",
              },
              {
                icon: Sparkles,
                title: "Research & Innovation",
                desc: "German institutions are known for cutting-edge research, innovation-driven teaching, and strong industry connections.",
              },
              {
                icon: Briefcase,
                title: "Work While You Study",
                desc: "Eligible student permit holders may work part-time during term and full-time during scheduled breaks, subject to current regulations.",
              },
              {
                icon: Plane,
                title: "Post-Study Work Pathways",
                desc: "Germany offers post-graduation work permit options for eligible graduates — contact our team for current eligibility details.",
              },
              {
                icon: Award,
                title: "Globally Recognised Degrees",
                desc: "German qualifications are respected by employers and institutions worldwide, supporting strong long-term career prospects.",
              },
              {
                icon: Shield,
                title: "Safe & Welcoming",
                desc: "Germany is consistently ranked among the safest and most livable countries, with a welcoming attitude toward international students.",
              },
              {
                icon: Users,
                title: "Multicultural Society",
                desc: "With a diverse, inclusive population, Germany offers a comfortable and enriching environment for students from every background.",
              },
              {
                icon: Wallet,
                title: "Affordable Education",
                desc: "Many German universities offer low or no tuition fees, making quality education accessible to international students.",
              },
              {
                icon: TrendingUp,
                title: "Career Opportunities",
                desc: "Germany offers strong employment prospects for graduates with its robust economy and diverse industries.",
              },
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-12 bg-red-50 border border-red-100 rounded-2xl p-8 max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a
                href={whatsappLink("Hi, I want to know more about studying in Germany.")}
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
            <div className="grid lg:grid-cols-2">
              ...
              <div className="bg-gray-900 p-8 lg:p-12 text-white">
                <h2 className="text-3xl font-bold mb-3">Apply for Germany Study Visa</h2>
                ...
                <div className="mt-8 pt-6 border-t border-white/20">
                  <div className="flex items-center gap-3 mb-5">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-400">Guiding students on their study abroad journey</p>
                    </div>
                  </div>
              ...
              <div className="p-8 lg:p-12">
                <form onSubmit={handleSubmit} noValidate className="space-y-5">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-gray-900 text-white py-4 rounded-lg font-semibold hover:bg-gray-800 active:bg-gray-950 transition-colors flex items-center justify-center gap-2 text-lg shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                  >
      ...
      {/* ══════════════════════════════════════════
          BOTTOM BANNER
      ══════════════════════════════════════════ */}
      <section className="relative bg-gradient-to-r from-gray-900 via-red-900 to-rose-900 text-white py-16 overflow-hidden">
        <div className="container mx-auto px-4 relative z-10 text-center max-w-3xl mx-auto">
          <h2 className="text-3xl lg:text-4xl font-bold mb-4">
            Start Your Journey to{" "}
            <span className="text-yellow-300">Germany</span>
          </h2>
          <p className="text-lg text-red-100 mb-8">
            Let IIL guide you toward world-class German education and career opportunities.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <button
              onClick={() => scrollToSection("enquiry")}
              className="bg-white text-gray-900 px-8 py-4 rounded-xl font-semibold hover:bg-red-50 hover:scale-105 transition-all duration-300 flex items-center gap-2"
            >
