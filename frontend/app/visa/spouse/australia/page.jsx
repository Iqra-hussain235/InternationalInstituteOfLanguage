...
function AustraliaFlag({ className }) {
  return (
    <svg className={className} viewBox="0 0 100 100">
      ...
      <rect x="10" y="10" width="80" height="80" fill="#012169" rx="48" clipPath="circle(48px at 50px 50px)"/>
      <clipPath id="ausClip">
      ...
      <g clipPath="url(#ausClip)">
        ...
        <circle cx="78" cy="35" r="2.5" fill="white"/>
        <circle cx="82" cy="48" r="2.5" fill="white"/>
        <circle cx="78" cy="61" r="2.5" fill="white"/>
...
const AustraliaSpousePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* ═══ FLOATING WHATSAPP ═══ */}
      <a
        href={whatsappLink("Hi, I'm interested in Australia Spouse Visa. Please share more information.")}
        target="_blank"
        ...
        >
          ...
          >
            ...
            <div className="flex gap-3">
              <a
                href={whatsappLink("Hi, I just submitted an enquiry for Australia Spouse Visa. Please assist me further.")}
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
                Spouse Visa<br /><span className="text-blue-200">Australia</span>
              </h1>
              <p className="text-lg text-blue-100 leading-relaxed max-w-xl">
                Reunite with your partner in Australia. Open work rights for your spouse,
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl bg-blue-900">
                {!imgError.hero ? (
                  <Image
                    src="/spouse-visa-australia.png"
                    alt="Australia Spouse Visa"
                    width={600}
                    height={400}
                ...
                <div className="absolute top-4 right-4 bg-white/95 backdrop-blur-sm rounded-xl px-4 py-3 shadow-lg">
                  ...
                  <div className="text-lg font-bold text-blue-700">SPOUSE VISA</div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative rounded-2xl overflow-hidden shadow-xl bg-gray-100">
              {!imgError.about ? (
                <Image
                  src="/spouse-about-australia.png"
                  alt="Couple in Australia"
                  width={600}
                  height={400}
                  className="w-full h-[400px] object-contain object-center"
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-600 leading-relaxed">
                Australia values family unity and offers clear pathways for spouses and partners to join
                their loved ones. Whether you are married, in a de facto relationship, or engaged,
                Australia provides options to live together.
              </p>
              <p className="text-gray-600 leading-relaxed">
                The Australia spouse visa allows your partner to join you, work with full work rights,
                study, and access Medicare. Together, you can build a future in one of the world's
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              Why Choose Australia Spouse Visa?
            </h2>
            <p className="text-gray-500 max-w-xl mx-auto">
              Key reasons couples choose Australia for reunification
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Your spouse can work full-time for any employer in Australia without restrictions.",
              },
              {
                icon: BookOpen,
                title: "Study Opportunities",
                desc: "Spouses can study at Australian institutions and gain globally recognised qualifications.",
              },
              {
                icon: Heart,
                title: "Live Together",
              ...
              },
              {
                ...
                desc: "Spouses get access to Australia's world-class public healthcare system.",
              },
              {
                icon: Award,
                title: "PR Pathway",
                desc: "Partner visas lead directly to permanent residency and Australian citizenship.",
              },
              {
                icon: Globe,
              ...
              },
              {
                ...
                desc: "Children can attend Australian public schools, receiving world-class education.",
              },
              {
                icon: Star,
                title: "Inclusive Society",
                desc: "Australia celebrates diversity. Couples from all backgrounds feel welcome and respected.",
              },
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-12 bg-blue-50 border border-blue-100 rounded-2xl p-8 max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a
                href={whatsappLink("Hi, I want to know more about Australia Spouse Visa.")}
                target="_blank"
                rel="noopener noreferrer"
              ...
              <div className="bg-blue-900 p-8 lg:p-12 text-white">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100">Spouse Visa</p>
                  </div>
                </div>
                <p className="text-blue-100 mb-8 text-sm leading-relaxed">
                  Fill out the form and our experts will guide you through the entire Australia spouse visa process.
                </p>
                <div className="space-y-5">
                  ...
                  <a href={whatsappLink("Hi, I'm interested in Australia Spouse Visa. Please share more information.")} target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 hover:translate-x-1 transition-transform">
                    <div className="w-11 h-11 bg-white/10 rounded-lg flex items-center justify-center shrink-0">
                ...
                <div className="mt-8 pt-6 border-t border-white/20">
                  <div className="flex items-center gap-3 mb-5">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-blue-200">Guiding couples on their visa journey</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                ...
                <form onSubmit={handleSubmit} noValidate className="space-y-5">
                  ...
                  <div>
                    ...
                    <select id="purpose" name="purpose" required value={formData.purpose} onChange={handleInputChange} className={`w-full px-4 py-3 border-2 ${formErrors.purpose ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : 'border-gray-200 focus:ring-blue-500 focus:border-blue-500'} rounded-lg outline-none transition-all text-gray-900`}>
                      ...
                      <option value="partner-visa-onshore">Partner Visa (Onshore - 820/801)</option>
                      <option value="partner-visa-offshore">Partner Visa (Offshore - 309/100)</option>
                      <option value="prospective-marriage">Prospective Marriage Visa (300)</option>
                  ...
                  <div>
                    ...
                    <textarea id="message" name="message" rows={3} autoComplete="off" placeholder="Tell us about your spouse visa requirements..." value={formData.message} onChange={handleInputChange} className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all resize-none text-gray-900 placeholder-gray-400" />
                  </div>
                  ...
                  <a href={whatsappLink("Hi, I'm interested in Australia Spouse Visa. Please share more information.")} target="_blank" rel="noopener noreferrer" className="w-full bg-[#25D366] text-white py-4 rounded-lg font-semibold hover:bg-[#1ebe57] transition-colors flex items-center justify-center gap-2">
      ...
      <section className="relative bg-gradient-to-r from-blue-900 via-blue-800 to-sky-700 text-white py-16 overflow-hidden">
        <div className="container mx-auto px-4 relative z-10 text-center max-w-3xl mx-auto">
          <h2 className="text-3xl lg:text-4xl font-bold mb-4">
            Reunite with Your Partner in <span className="text-blue-200">Australia</span>
          </h2>
          <p className="text-lg text-blue-100 mb-8">
            Let IIL guide you toward bringing your spouse to Australia. Contact us today!
          </p>
          <div className="flex flex-wrap justify-center gap-4">
...
export default AustraliaSpousePage;