...
const CanadaSpousePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* ═══ FLOATING WHATSAPP ═══ */}
      <a
        href={whatsappLink("Hi, I'm interested in Canada Spouse Visa. Please share more information.")}
        target="_blank"
        ...
        >
          ...
          >
            ...
            <div className="flex gap-3">
              <a
                href={whatsappLink("Hi, I just submitted an enquiry for Canada Spouse Visa. Please assist me further.")}
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
                Spouse Visa<br /><span className="text-red-200">Canada</span>
              </h1>
              <p className="text-lg text-red-100 leading-relaxed max-w-xl">
                Reunite with your partner in Canada. Open work permit for your spouse,
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl bg-red-900">
                ...
                <div className="absolute top-4 right-4 bg-white/95 backdrop-blur-sm rounded-xl px-4 py-3 shadow-lg">
                  ...
                  <div className="text-lg font-bold text-red-700">SPOUSE VISA</div>
                </div>
              </div>
      ...
      {/* ═══ ABOUT CANADA SPOUSE VISA SECTION ═══ */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-600 leading-relaxed">
                Canada values family unity and offers clear pathways for spouses and partners to join
                their loved ones. Whether you are married, in a common-law relationship, or conjugal
                partners, Canada provides options to live together.
              </p>
              <p className="text-gray-600 leading-relaxed">
                The Canada spouse visa allows your partner to join you, work with an open work permit,
                study, and access healthcare. Together, you can build a future in one of the world's
      ...
      {/* ═══ WHY CANADA SPOUSE VISA SECTION ═══ */}
      <section className="py-16 lg:py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              Why Choose Canada Spouse Visa?
            </h2>
            <p className="text-gray-500 max-w-xl mx-auto">
              Key reasons couples choose Canada for reunification
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Your spouse can work full-time for any employer in Canada without needing a separate job offer.",
              },
              {
                icon: BookOpen,
                title: "Study Opportunities",
                desc: "Spouses can study at Canadian institutions and gain globally recognised qualifications.",
              },
              {
                icon: Heart,
                title: "Live Together",
              ...
              },
              {
                ...
                desc: "Spouses get access to Canada's world-class public healthcare system in most provinces.",
              },
              {
                icon: Award,
                title: "PR Pathway",
                desc: "Time spent on spouse visa counts toward permanent residency. Family sponsorship leads to PR.",
              },
              {
                icon: Globe,
                title: "Quality of Life",
                desc: "Safe cities, multicultural communities, clean environment, and excellent work-life balance.",
              },
              {
                icon: Wallet,
                title: "Dual Income",
              ...
              },
              {
                ...
                desc: "Children can attend Canadian public schools for free, receiving world-class education.",
              },
              {
                icon: Star,
                title: "Inclusive Society",
                desc: "Canada celebrates diversity. Couples from all backgrounds feel welcome and respected.",
              },
        ...
        <div className="container mx-auto px-4">
            ...
            {[
              {
                icon: Compass,
                title: "Visa Guidance",
                desc: "Personalised advice on the right spouse visa pathway based on your relationship and circumstances.",
              },
              {
                icon: FileText,
          ...
          <div className="mt-12 bg-red-50 border border-red-100 rounded-2xl p-8 max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a
                href={whatsappLink("Hi, I want to know more about Canada Spouse Visa.")}
                target="_blank"
                rel="noopener noreferrer"
              ...
              <div className="bg-red-900 p-8 lg:p-12 text-white">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-red-100">Spouse Visa</p>
                  </div>
                </div>
                <p className="text-red-100 mb-8 text-sm leading-relaxed">
                  Fill out the form and our experts will guide you through the entire Canada spouse visa process.
                </p>
                <div className="space-y-5">
                  ...
                  <a href={whatsappLink("Hi, I'm interested in Canada Spouse Visa. Please share more information.")} target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 hover:translate-x-1 transition-transform">
                    <div className="w-11 h-11 bg-white/10 rounded-lg flex items-center justify-center shrink-0">
                ...
                <div className="mt-8 pt-6 border-t border-white/20">
                  <div className="flex items-center gap-3 mb-5">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-red-200">Guiding couples on their visa journey</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                ...
                <form onSubmit={handleSubmit} noValidate className="space-y-5">
                  ...
                  <div>
                    ...
                    <select id="purpose" name="purpose" required value={formData.purpose} onChange={handleInputChange} className={`w-full px-4 py-3 border-2 ${formErrors.purpose ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : 'border-gray-200 focus:ring-red-500 focus:border-red-500'} rounded-lg outline-none transition-all text-gray-900`}>
                      ...
                      <option value="spouse-sponsorship">Spouse Sponsorship (Inland)</option>
                      <option value="spouse-sponsorship-outland">Spouse Sponsorship (Outland)</option>
                      <option value="common-law">Common-Law Partner Sponsorship</option>
                      <option value="conjugal">Conjugal Partner Sponsorship</option>
                      <option value="open-work-permit">Open Work Permit for Spouse</option>
                  ...
                  <div>
                    ...
                    <textarea id="message" name="message" rows={3} autoComplete="off" placeholder="Tell us about your spouse visa requirements..." value={formData.message} onChange={handleInputChange} className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none transition-all resize-none text-gray-900 placeholder-gray-400" />
                  </div>
                  ...
                  <a href={whatsappLink("Hi, I'm interested in Canada Spouse Visa. Please share more information.")} target="_blank" rel="noopener noreferrer" className="w-full bg-[#25D366] text-white py-4 rounded-lg font-semibold hover:bg-[#1ebe57] transition-colors flex items-center justify-center gap-2">
      ...
      <section className="relative bg-gradient-to-r from-red-900 via-red-800 to-rose-700 text-white py-16 overflow-hidden">
        <div className="container mx-auto px-4 relative z-10 text-center max-w-3xl mx-auto">
          <h2 className="text-3xl lg:text-4xl font-bold mb-4">
            Reunite with Your Partner in <span className="text-red-200">Canada</span>
          </h2>
          <p className="text-lg text-red-100 mb-8">
            Let IIL guide you toward bringing your spouse to Canada. Contact us today!
          </p>
          <div className="flex flex-wrap justify-center gap-4">
...
export default CanadaSpousePage;